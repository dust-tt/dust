...
import { ActionDetailsWrapper } from "@extension/components/conversation/actions/ActionDetailsWrapper";
import type { ActionDetailsComponentBaseProps } from "@extension/components/conversation/actions/types";
