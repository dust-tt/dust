// TODO(sandbox-egress): Remove this allowance in PR 2 when connection handling validates forwarder
// JWTs. PR 1 keeps the validator covered by unit tests only.
#![allow(dead_code)]
