// TODO(sandbox-egress): Remove this allowance in PR 2 when the TLS accept loop starts calling the
// parser for real sandbox forwarder connections. PR 1 keeps the parser covered by unit tests only.
#![allow(dead_code)]
