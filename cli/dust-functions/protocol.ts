// Wire protocol for run_request: the JSON shapes exchanged on stdin/stdout
// and the helpers that translate request/response bodies to and from bytes.
// Pure functions only — no I/O, no knowledge of handlers.
...
/** Thrown when stdin is not valid JSON matching the input shape. */
