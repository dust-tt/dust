...
/// placeholder format (`__DSEC_<32hex>__` where the hex is a per-secret
/// 16-byte nonce stored on the row) and a per-secret `allowedDomains`
/// policy gate. See design_docs/SECRET_SWAP_DESIGN.md, sections
