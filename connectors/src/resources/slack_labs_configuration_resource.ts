...
export class SlackLabsConfigurationResource extends BaseResource<SlackLabsConfigurationModel> {
  ...
  constructor(model: typeof SlackLabsConfigurationModel, blob: any) {
  ...
  toJSON(): SlackLabsConfigurationType {
    return {
      channelId: (this as any).channelId,
      agentConfigurationId: (this as any).agentConfigurationId,
      isEnabled: (this as any).isEnabled,
    };
  }
}
