...
export async function autoReadChannelsBulk(
  ...
  // Process all channels (update DB and data sources)
  for (const channelInfo of channelsToProcess) {
    const { channelId, channelName, isPrivate, matchingPatterns } = channelInfo;
