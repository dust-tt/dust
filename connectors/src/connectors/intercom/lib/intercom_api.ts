...
/**
 * Return the Help Centers of the Intercom workspace
 * Not available via the Node SDK, calling the API directly.
 */
...
/**
 * Return the Intercom Help Center Collections.
 */
...
/**
 * Return the Intercom Help Center Collection.
 */
...
/**
 * Return the Intercom Help Center Articles.
 */
...
/**
 * Return the Intercom Help Center Article.
 */
...
/**
 * Return true if an Intercom Help Center Article exists.
 */
export async function isArticleOnIntercom(
  intercomClient: Client,
  articleId: string
): Promise<boolean> {
  try {
    await getIntercomArticle(intercomClient, articleId);
    return true;
  } catch (error: unknown) {
