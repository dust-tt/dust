export default async function setup() {
  ...
  if (
    ...
    throw new Error(
      `CONNECTORS_DATABASE_URI must be set to a test DB (value: ${process.env.CONNECTORS_DATABASE_URI}). Action: make sure your have the correct environnement variable set.`
    );
  }
