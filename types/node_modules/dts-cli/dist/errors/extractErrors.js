...
async function extractErrors(opts) {
    ...
    existingErrorMap = (0, invertObject_1.invertObject)(existingErrorMap);
    function transform(source) {
        const ast = (0, parser_1.parse)(source, babelParserOptions);
    ...
    async function flush() {
        const prettyName = (0, pascal_case_1.pascalCase)((0, utils_1.safeVariableName)(opts.name));
        ...
        await fs_extra_1.default.writeFile(errorMapFilePath, JSON.stringify((0, invertObject_1.invertObject)(existingErrorMap), null, 2) + '\n', 'utf-8');
