...
var partial = function (properties) {
    return (0, pipeable_1.pipe)(exports.UnknownRecord, (0, exports.compose)((0, exports.fromPartial)(properties)));
};
 ...
 * @since 2.2.7
 */
var sum = function (tag) { return function (members) { return (0, pipeable_1.pipe)(exports.UnknownRecord, (0, exports.compose)((0, exports.fromSum)(tag)(members))); }; };
exports.sum = sum;
/**
 * @category combinators
 * @since 2.2.7
