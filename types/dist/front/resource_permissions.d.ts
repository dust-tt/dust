...
export declare const SUPPORTED_OPERATIONS: readonly ["admin", "read", "write"];
 ...
 */
export type ResourcePermission = GroupResourcePermissions | CombinedResourcePermissions;
/**
 ...
 */
export declare function hasRolePermissions(resourcePermission: ResourcePermission): resourcePermission is CombinedResourcePermissions;
export {};
//# sourceMappingURL=resource_permissions.d.ts.map