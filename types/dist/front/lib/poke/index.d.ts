...
import { AgentMessageType, ConversationType, UserMessageType } from "../../assistant/conversation";
...
export type PokeDataSourceType = DataSourceType & PokeItemBase & {
    space: PokeSpaceType;
};
export type PokeDataSourceViewType = DataSourceViewType & PokeItemBase & {
...
export type PokeConversationType = Omit<ConversationType, "content"> & {
    content: (UserMessageType[] | PokeAgentMessageType[] | ContentFragmentType[])[];
};
export {};
