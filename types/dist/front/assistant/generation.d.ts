...
export type ModelMessageTypeMultiActions = ContentFragmentMessageTypeModel | UserMessageTypeModel | AssistantFunctionCallMessageTypeModel | AssistantContentMessageTypeModel | FunctionMessageTypeModel;
export declare function isContentFragmentMessageTypeModel(contentFragment: ModelMessageTypeMultiActions): contentFragment is ContentFragmentMessageTypeModel;
export declare function isUserMessageTypeModel(userMessage: ModelMessageTypeMultiActions): userMessage is UserMessageTypeModel;
