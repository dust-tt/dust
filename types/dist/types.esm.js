...
import { NonEmptyString as NonEmptyString$1 } from 'io-ts-types';
import { NumberFromString } from 'io-ts-types/lib/NumberFromString';
import { createClient } from 'redis';
import { StatsD } from 'hot-shots';
import * as child_process from 'child_process';
import { isLeft as isLeft$1 } from 'fp-ts/Either';
import { Parser } from 'htmlparser2';
import { Readable, Transform } from 'stream';
import { stringify } from 'csv-stringify/sync';
import crypto from 'crypto';
import { parse, CsvError } from 'csv-parse';
import { stringify as stringify$1 } from 'csv-stringify';
...
function ioTsEnum(enumValues, enumName) {
  ...
  return new t.Type(enumName || v4(), isEnumValue, function (input, context) {
...
function createRangeCodec(min, max) {
  return t.brand(t.number, function (n) {
    return n >= min && n <= max;
  }, "Range");
}
var SlugifiedString = /*#__PURE__*/t.brand(t.string, function (s) {
  return /^[a-z0-9_]+$/.test(s);
}, "SlugifiedString");
function ioTsParsePayload(payload, codec) {
  var bodyValidation = codec.decode(payload);
  if (isLeft(bodyValidation)) {
    var pathError = reporter.formatValidationErrors(bodyValidation.left);
...
var NumberAsStringCodec = /*#__PURE__*/new t.Type("NumberAsString", function (u) {
...
var ConnectorsCommandSchema = /*#__PURE__*/t.type({
  majorCommand: /*#__PURE__*/t.literal("connectors"),
  command: /*#__PURE__*/t.union([/*#__PURE__*/t.literal("stop"), /*#__PURE__*/t.literal("delete"), /*#__PURE__*/t.literal("pause"), /*#__PURE__*/t.literal("unpause"), /*#__PURE__*/t.literal("resume"), /*#__PURE__*/t.literal("full-resync"), /*#__PURE__*/t.literal("set-error"), /*#__PURE__*/t.literal("clear-error"), /*#__PURE__*/t.literal("restart"), /*#__PURE__*/t.literal("get-parents"), /*#__PURE__*/t.literal("set-permission"), /*#__PURE__*/t.literal("garbage-collect")]),
  args: /*#__PURE__*/t.record(t.string, /*#__PURE__*/t.union([t.string, NumberAsStringCodec, t.undefined]))
});
/**
 * <Confluence>
 */
var ConfluenceCommandSchema = /*#__PURE__*/t.type({
  majorCommand: /*#__PURE__*/t.literal("confluence"),
  command: /*#__PURE__*/t.union([/*#__PURE__*/t.literal("me"), /*#__PURE__*/t.literal("upsert-page"), /*#__PURE__*/t.literal("upsert-pages"), /*#__PURE__*/t.literal("update-parents")]),
  args: /*#__PURE__*/t.type({
    connectorId: /*#__PURE__*/t.union([t.number, t.undefined]),
    pageId: /*#__PURE__*/t.union([t.number, t.undefined]),
    spaceId: /*#__PURE__*/t.union([t.number, t.undefined]),
    file: /*#__PURE__*/t.union([t.string, t.undefined]),
    keyInFile: /*#__PURE__*/t.union([t.string, t.undefined])
  })
});
var ConfluenceMeResponseSchema = /*#__PURE__*/t.type({
  me: t.UnknownRecord
});
var ConfluenceUpsertPageResponseSchema = /*#__PURE__*/t.type({
  workflowId: t.string,
  workflowUrl: /*#__PURE__*/t.union([t.string, t.undefined])
});
/**
 * </Confluence>
 */
var GithubCommandSchema = /*#__PURE__*/t.type({
  majorCommand: /*#__PURE__*/t.literal("github"),
  command: /*#__PURE__*/t.union([/*#__PURE__*/t.literal("resync-repo"), /*#__PURE__*/t.literal("code-sync"), /*#__PURE__*/t.literal("sync-issue"), /*#__PURE__*/t.literal("force-daily-code-sync"), /*#__PURE__*/t.literal("skip-issue")]),
  args: /*#__PURE__*/t.record(t.string, /*#__PURE__*/t.union([t.string, NumberAsStringCodec, t.undefined]))
});
var NotionCommandSchema = /*#__PURE__*/t.type({
  majorCommand: /*#__PURE__*/t.literal("notion"),
  command: /*#__PURE__*/t.union([/*#__PURE__*/t.literal("skip-page"), /*#__PURE__*/t.literal("skip-database"), /*#__PURE__*/t.literal("upsert-page"), /*#__PURE__*/t.literal("upsert-database"), /*#__PURE__*/t.literal("search-pages"), /*#__PURE__*/t.literal("update-core-parents"), /*#__PURE__*/t.literal("check-url"), /*#__PURE__*/t.literal("find-url"), /*#__PURE__*/t.literal("delete-url"), /*#__PURE__*/t.literal("me"), /*#__PURE__*/t.literal("stop-all-garbage-collectors"), /*#__PURE__*/t.literal("update-parents-fields"), /*#__PURE__*/t.literal("clear-parents-last-updated-at")]),
  args: /*#__PURE__*/t.record(t.string, /*#__PURE__*/t.union([t.string, NumberAsStringCodec, t.undefined]))
});
var GoogleDriveCommandSchema = /*#__PURE__*/t.type({
  majorCommand: /*#__PURE__*/t.literal("google_drive"),
  command: /*#__PURE__*/t.union([/*#__PURE__*/t.literal("garbage-collect-all"), /*#__PURE__*/t.literal("get-file"), /*#__PURE__*/t.literal("check-file"), /*#__PURE__*/t.literal("get-google-parents"), /*#__PURE__*/t.literal("clean-invalid-parents"), /*#__PURE__*/t.literal("upsert-file"), /*#__PURE__*/t.literal("update-core-parents"), /*#__PURE__*/t.literal("restart-google-webhooks"), /*#__PURE__*/t.literal("start-incremental-sync"), /*#__PURE__*/t.literal("restart-all-incremental-sync-workflows"), /*#__PURE__*/t.literal("skip-file"), /*#__PURE__*/t.literal("register-webhook"), /*#__PURE__*/t.literal("register-all-webhooks"), /*#__PURE__*/t.literal("list-labels")]),
  args: /*#__PURE__*/t.record(t.string, /*#__PURE__*/t.union([t.string, NumberAsStringCodec, t.undefined]))
});
var SlackCommandSchema = /*#__PURE__*/t.type({
  majorCommand: /*#__PURE__*/t.literal("slack"),
  command: /*#__PURE__*/t.union([/*#__PURE__*/t.literal("enable-bot"), /*#__PURE__*/t.literal("sync-channel"), /*#__PURE__*/t.literal("sync-thread"), /*#__PURE__*/t.literal("uninstall-for-unknown-team-ids"), /*#__PURE__*/t.literal("whitelist-domains"), /*#__PURE__*/t.literal("whitelist-bot"), /*#__PURE__*/t.literal("sync-channel-metadata")]),
  args: /*#__PURE__*/t.record(t.string, /*#__PURE__*/t.union([t.string, NumberAsStringCodec, t.undefined]))
});
var BatchCommandSchema = /*#__PURE__*/t.type({
  majorCommand: /*#__PURE__*/t.literal("batch"),
  command: /*#__PURE__*/t.union([/*#__PURE__*/t.literal("full-resync"), /*#__PURE__*/t.literal("restart-all"), /*#__PURE__*/t.literal("stop-all"), /*#__PURE__*/t.literal("resume-all")]),
  args: /*#__PURE__*/t.record(t.string, /*#__PURE__*/t.union([t.string, NumberAsStringCodec, t.undefined]))
});
var WebcrawlerCommandSchema = /*#__PURE__*/t.type({
  majorCommand: /*#__PURE__*/t.literal("webcrawler"),
  command: /*#__PURE__*/t.literal("start-scheduler")
});
var BatchAllResponseSchema = /*#__PURE__*/t.type({
  succeeded: t.number,
  failed: t.number
});
var TemporalCommandSchema = /*#__PURE__*/t.type({
  majorCommand: /*#__PURE__*/t.literal("temporal"),
  command: /*#__PURE__*/t.union([/*#__PURE__*/t.literal("find-unprocessed-workflows"), /*#__PURE__*/t.literal("check-queue")]),
  args: /*#__PURE__*/t.record(t.string, /*#__PURE__*/t.union([t.string, NumberAsStringCodec, t.undefined]))
});
/**
 * <Intercom>
 */
var IntercomCommandSchema = /*#__PURE__*/t.type({
  majorCommand: /*#__PURE__*/t.literal("intercom"),
  command: /*#__PURE__*/t.union([/*#__PURE__*/t.literal("force-resync-articles"), /*#__PURE__*/t.literal("check-conversation"), /*#__PURE__*/t.literal("fetch-conversation"), /*#__PURE__*/t.literal("fetch-articles"), /*#__PURE__*/t.literal("check-missing-conversations"), /*#__PURE__*/t.literal("check-teams")]),
  args: /*#__PURE__*/t.type({
    force: /*#__PURE__*/t.union([/*#__PURE__*/t.literal("true"), t.undefined]),
    connectorId: /*#__PURE__*/t.union([t.number, t.undefined]),
    conversationId: /*#__PURE__*/t.union([t.number, t.undefined]),
    day: /*#__PURE__*/t.union([t.string, t.undefined]),
    helpCenterId: /*#__PURE__*/t.union([t.number, t.undefined])
  })
});
var IntercomCheckConversationResponseSchema = /*#__PURE__*/t.type({
  isConversationOnIntercom: t["boolean"],
  isConversationOnDB: t["boolean"],
  conversationTeamIdOnIntercom: /*#__PURE__*/t.union([t.string, t.undefined]),
  conversationTeamIdOnDB: /*#__PURE__*/t.union([t.string, t.undefined, t["null"]])
});
var IntercomFetchConversationResponseSchema = /*#__PURE__*/t.type({
  conversation: /*#__PURE__*/t.union([t.UnknownRecord, t["null"]]) // intercom type, can't be iots'd
});
var IntercomFetchArticlesResponseSchema = /*#__PURE__*/t.type({
  articles: /*#__PURE__*/t.array( /*#__PURE__*/t.union([t.UnknownRecord, t["null"]])) // intercom type, can't be iots'd
});
var IntercomCheckTeamsResponseSchema = /*#__PURE__*/t.type({
  teams: /*#__PURE__*/t.array( /*#__PURE__*/t.type({
    teamId: t.string,
    name: t.string,
    isTeamOnDB: t["boolean"]
  }))
});
var IntercomCheckMissingConversationsResponseSchema = /*#__PURE__*/t.type({
  missingConversations: /*#__PURE__*/t.array( /*#__PURE__*/t.type({
    conversationId: t.string,
    teamId: /*#__PURE__*/t.union([t.number, t["null"]]),
    open: t["boolean"],
    createdAt: t.number
  }))
});
var IntercomForceResyncArticlesResponseSchema = /*#__PURE__*/t.type({
 ...
 * <Zendesk>
 */
var ZendeskCommandSchema = /*#__PURE__*/t.type({
  majorCommand: /*#__PURE__*/t.literal("zendesk"),
  command: /*#__PURE__*/t.union([/*#__PURE__*/t.literal("check-is-admin"), /*#__PURE__*/t.literal("count-tickets"), /*#__PURE__*/t.literal("resync-tickets"), /*#__PURE__*/t.literal("fetch-ticket"), /*#__PURE__*/t.literal("fetch-brand"), /*#__PURE__*/t.literal("resync-help-centers"), /*#__PURE__*/t.literal("resync-brand-metadata")]),
  args: /*#__PURE__*/t.type({
    wId: /*#__PURE__*/t.union([t.string, t.undefined]),
    dsId: /*#__PURE__*/t.union([t.string, t.undefined]),
    connectorId: /*#__PURE__*/t.union([t.number, t.undefined]),
    brandId: /*#__PURE__*/t.union([t.number, t.undefined]),
    query: /*#__PURE__*/t.union([t.string, t.undefined]),
    forceResync: /*#__PURE__*/t.union([/*#__PURE__*/t.literal("true"), t.undefined]),
    ticketId: /*#__PURE__*/t.union([t.number, t.undefined]),
    ticketUrl: /*#__PURE__*/t.union([t.string, t.undefined])
  })
});
var ZendeskCheckIsAdminResponseSchema = /*#__PURE__*/t.type({
  userRole: t.string,
  userActive: t["boolean"],
  userIsAdmin: t["boolean"]
});
var ZendeskCountTicketsResponseSchema = /*#__PURE__*/t.type({
  ticketCount: t.number
});
var ZendeskFetchTicketResponseSchema = /*#__PURE__*/t.type({
  ticket: /*#__PURE__*/t.union([t.UnknownRecord, t["null"]]),
  // Zendesk type, can't be iots'd,
  isTicketOnDb: t["boolean"]
});
var ZendeskFetchBrandResponseSchema = /*#__PURE__*/t.type({
  brand: /*#__PURE__*/t.union([t.UnknownRecord, t["null"]]),
  // Zendesk type, can't be iots'd,
  brandOnDb: /*#__PURE__*/t.union([t.UnknownRecord, t["null"]])
});
/**
 * </Zendesk>
 */
var MicrosoftCommandSchema = /*#__PURE__*/t.type({
  majorCommand: /*#__PURE__*/t.literal("microsoft"),
  command: /*#__PURE__*/t.union([/*#__PURE__*/t.literal("garbage-collect-all"), /*#__PURE__*/t.literal("check-file"), /*#__PURE__*/t.literal("start-incremental-sync"), /*#__PURE__*/t.literal("restart-all-incremental-sync-workflows"), /*#__PURE__*/t.literal("skip-file"), /*#__PURE__*/t.literal("sync-node"), /*#__PURE__*/t.literal("get-parents")]),
  args: /*#__PURE__*/t.record(t.string, /*#__PURE__*/t.union([t.string, NumberAsStringCodec, t.undefined]))
});
var AdminCommandSchema = /*#__PURE__*/t.union([BatchCommandSchema, ConnectorsCommandSchema, ConfluenceCommandSchema, GithubCommandSchema, GoogleDriveCommandSchema, IntercomCommandSchema, MicrosoftCommandSchema, NotionCommandSchema, SlackCommandSchema, TemporalCommandSchema, WebcrawlerCommandSchema, ZendeskCommandSchema]);
var AdminSuccessResponseSchema = /*#__PURE__*/t.type({
  success: /*#__PURE__*/t.literal(true)
});
var CheckFileGenericResponseSchema = /*#__PURE__*/t.type({
  status: t.number,
  // all literals from js `typeof`
  type: /*#__PURE__*/t.union([/*#__PURE__*/t.literal("undefined"), /*#__PURE__*/t.literal("object"), /*#__PURE__*/t.literal("boolean"), /*#__PURE__*/t.literal("number"), /*#__PURE__*/t.literal("string"), /*#__PURE__*/t.literal("function"), /*#__PURE__*/t.literal("symbol"), /*#__PURE__*/t.literal("bigint")]),
  content: t.unknown // google drive type, can't be iots'd
});
var GetParentsResponseSchema = /*#__PURE__*/t.type({
  parents: /*#__PURE__*/t.array(t.string)
});
var NotionUpsertResponseSchema = /*#__PURE__*/t.type({
  workflowId: t.string,
  workflowUrl: /*#__PURE__*/t.union([t.string, t.undefined])
});
var NotionSearchPagesResponseSchema = /*#__PURE__*/t.type({
  pages: /*#__PURE__*/t.array( /*#__PURE__*/t.type({
    id: t.string,
    title: /*#__PURE__*/t.union([t.string, t.undefined]),
    type: /*#__PURE__*/t.union([/*#__PURE__*/t.literal("page"), /*#__PURE__*/t.literal("database")]),
    isSkipped: t["boolean"],
    isFull: t["boolean"]
  }))
});
var NotionCheckUrlResponseSchema = /*#__PURE__*/t.type({
  page: /*#__PURE__*/t.union([t.UnknownRecord, t["null"]]),
  // notion type, can't be iots'd
  db: /*#__PURE__*/t.union([t.UnknownRecord, t["null"]]) // notion type, can't be iots'd
});
var NotionDeleteUrlResponseSchema = /*#__PURE__*/t.type({
  deletedPage: t["boolean"],
  deletedDb: t["boolean"]
});
var NotionFindUrlResponseSchema = /*#__PURE__*/t.type({
  page: /*#__PURE__*/t.union([t.UnknownRecord, t["null"]]),
  // notion type, can't be iots'd
  db: /*#__PURE__*/t.union([t.UnknownRecord, t["null"]]) // notion type, can't be iots'd
});
var NotionMeResponseSchema = /*#__PURE__*/t.type({
  me: t.UnknownRecord,
  // notion type, can't be iots'd
  botOwner: t.UnknownRecord // notion type, can't be iots'd
});
var TemporalCheckQueueResponseSchema = /*#__PURE__*/t.type({
  taskQueue: t.UnknownRecord // temporal type, can't be iots'd
});
var TemporalUnprocessedWorkflowsResponseSchema = /*#__PURE__*/t.type({
  queuesAndPollers: /*#__PURE__*/t.array( /*#__PURE__*/t.type({
    queue: t.string,
    pollers: t.number
  })),
  unprocessedQueues: /*#__PURE__*/t.array(t.string)
});
var AdminResponseSchema = /*#__PURE__*/t.union([AdminSuccessResponseSchema, BatchAllResponseSchema, CheckFileGenericResponseSchema, ConfluenceMeResponseSchema, ConfluenceUpsertPageResponseSchema, GetParentsResponseSchema, IntercomCheckConversationResponseSchema, IntercomCheckMissingConversationsResponseSchema, IntercomCheckTeamsResponseSchema, IntercomFetchConversationResponseSchema, IntercomFetchArticlesResponseSchema, NotionCheckUrlResponseSchema, NotionDeleteUrlResponseSchema, NotionMeResponseSchema, NotionSearchPagesResponseSchema, NotionUpsertResponseSchema, TemporalCheckQueueResponseSchema, TemporalUnprocessedWorkflowsResponseSchema, IntercomForceResyncArticlesResponseSchema, ZendeskCheckIsAdminResponseSchema, ZendeskCountTicketsResponseSchema, ZendeskFetchTicketResponseSchema, ZendeskFetchBrandResponseSchema]);

function isConnectorsAPIError(obj) {
  return typeof obj === "object" && obj !== null && "message" in obj && typeof obj.message === "string" && "type" in obj && typeof obj.type === "string";
}

// Auto-read patterns.
var SlackAutoReadPatternSchema = /*#__PURE__*/t.type({
  pattern: t.string,
  spaceId: t.string
});
var SlackAutoReadPatternsSchema = /*#__PURE__*/t.array(SlackAutoReadPatternSchema);
function isSlackAutoReadPatterns(v) {
  return SlackAutoReadPatternsSchema.is(v);
}
// Configuration.
var SlackConfigurationTypeSchema = /*#__PURE__*/t.type({
  botEnabled: t["boolean"],
  whitelistedDomains: /*#__PURE__*/t.union([/*#__PURE__*/t.array(t.string), t.undefined]),
...
var WebCrawlerConfigurationTypeSchema = /*#__PURE__*/t.type({
  url: t.string,
  depth: /*#__PURE__*/t.union([/*#__PURE__*/t.literal(0), /*#__PURE__*/t.literal(1), /*#__PURE__*/t.literal(2), /*#__PURE__*/t.literal(3), /*#__PURE__*/t.literal(4), /*#__PURE__*/t.literal(5)]),
  maxPageToCrawl: t.number,
  crawlMode: /*#__PURE__*/t.union([/*#__PURE__*/t.literal("child"), /*#__PURE__*/t.literal("website")]),
  crawlFrequency: /*#__PURE__*/t.union([/*#__PURE__*/t.literal("never"), /*#__PURE__*/t.literal("daily"), /*#__PURE__*/t.literal("weekly"), /*#__PURE__*/t.literal("monthly")]),
  headers: /*#__PURE__*/t.record(t.string, t.string)
});
...
var ConnectorConfigurationTypeSchema = /*#__PURE__*/t.union([WebCrawlerConfigurationTypeSchema, SlackConfigurationTypeSchema, t["null"]]);
var UpdateConnectorConfigurationTypeSchema = /*#__PURE__*/t.type({
  configuration: ConnectorConfigurationTypeSchema
});

var ConnectorCreateRequestBodySchema = /*#__PURE__*/t.type({
...
var UpdateConnectorRequestBodySchema = /*#__PURE__*/t.type({
  connectionId: t.string
});
...
var ContentNodesViewTypeCodec = /*#__PURE__*/t.union([/*#__PURE__*/t.literal("table"), /*#__PURE__*/t.literal("document"), /*#__PURE__*/t.literal("all")]);
...
var ParsedNotionDatabaseSchema = /*#__PURE__*/t.type({
  id: t.string,
  url: t.string,
  title: /*#__PURE__*/t.union([t.string, t.undefined]),
  parentType: /*#__PURE__*/t.union([/*#__PURE__*/t.literal("database"), /*#__PURE__*/t.literal("page"), /*#__PURE__*/t.literal("block"), /*#__PURE__*/t.literal("workspace")]),
  parentId: t.string,
  archived: t["boolean"]
});
...
})(GLOBAL_AGENTS_SID || (GLOBAL_AGENTS_SID = {}));
...
var CUSTOM_ORDER = [GLOBAL_AGENTS_SID.DUST, GLOBAL_AGENTS_SID.GPT4, GLOBAL_AGENTS_SID.O3_MINI, GLOBAL_AGENTS_SID.SLACK, GLOBAL_AGENTS_SID.NOTION, GLOBAL_AGENTS_SID.GOOGLE_DRIVE, GLOBAL_AGENTS_SID.GITHUB, GLOBAL_AGENTS_SID.INTERCOM, GLOBAL_AGENTS_SID.CLAUDE_3_OPUS, GLOBAL_AGENTS_SID.CLAUDE_3_SONNET, GLOBAL_AGENTS_SID.CLAUDE_3_HAIKU, GLOBAL_AGENTS_SID.CLAUDE_3_7_SONNET, GLOBAL_AGENTS_SID.CLAUDE_2, GLOBAL_AGENTS_SID.CLAUDE_INSTANT, GLOBAL_AGENTS_SID.MISTRAL_LARGE, GLOBAL_AGENTS_SID.MISTRAL_MEDIUM, GLOBAL_AGENTS_SID.MISTRAL_SMALL, GLOBAL_AGENTS_SID.GEMINI_PRO, GLOBAL_AGENTS_SID.HELPER];
...
// of AgentGetViewType
var GetAgentConfigurationsQuerySchema = /*#__PURE__*/t.type({
  view: /*#__PURE__*/t.union([/*#__PURE__*/t.literal("current_user"), /*#__PURE__*/t.literal("list"), /*#__PURE__*/t.literal("workspace"), /*#__PURE__*/t.literal("published"), /*#__PURE__*/t.literal("global"), /*#__PURE__*/t.literal("admin_internal"), /*#__PURE__*/t.literal("all"), t.undefined]),
  withUsage: /*#__PURE__*/t.union([/*#__PURE__*/t.literal("true"), /*#__PURE__*/t.literal("false"), t.undefined]),
  withAuthors: /*#__PURE__*/t.union([/*#__PURE__*/t.literal("true"), /*#__PURE__*/t.literal("false"), t.undefined]),
  withFeedbacks: /*#__PURE__*/t.union([/*#__PURE__*/t.literal("true"), /*#__PURE__*/t.literal("false"), t.undefined]),
  limit: /*#__PURE__*/t.union([LimitCodec, t.undefined]),
  sort: /*#__PURE__*/t.union([/*#__PURE__*/t.literal("priority"), /*#__PURE__*/t.literal("alphabetical"), t.undefined])
});
var GetAgentConfigurationsHistoryQuerySchema = /*#__PURE__*/t.type({
  limit: /*#__PURE__*/t.union([LimitCodec, t.undefined])
});
var GetAgentConfigurationsLeaderboardQuerySchema = /*#__PURE__*/t.type({
  view: /*#__PURE__*/t.union([/*#__PURE__*/t.literal("list"), /*#__PURE__*/t.literal("workspace"), /*#__PURE__*/t.literal("published"), /*#__PURE__*/t.literal("global"), /*#__PURE__*/t.literal("admin_internal"), /*#__PURE__*/t.literal("manage-assistants-search"), /*#__PURE__*/t.literal("all")])
});
var DataSourceFilterParentsCodec = /*#__PURE__*/t.union([/*#__PURE__*/t.type({
  "in": /*#__PURE__*/t.array(t.string),
  not: /*#__PURE__*/t.array(t.string)
}), t["null"]]);
var OptionalDataSourceFilterTagsCodec = /*#__PURE__*/t.partial({
  tags: /*#__PURE__*/t.union([/*#__PURE__*/t.type({
    "in": /*#__PURE__*/t.array(t.string),
    not: /*#__PURE__*/t.array(t.string),
    mode: /*#__PURE__*/t.union([/*#__PURE__*/t.literal("custom"), /*#__PURE__*/t.literal("auto")])
  }), t["null"]])
});
var DataSourceFilterCodec = /*#__PURE__*/t.intersection([/*#__PURE__*/t.type({
  parents: DataSourceFilterParentsCodec
}), OptionalDataSourceFilterTagsCodec]);
var RetrievalActionConfigurationSchema = /*#__PURE__*/t.type({
  type: /*#__PURE__*/t.literal("retrieval_configuration"),
  query: /*#__PURE__*/t.union([/*#__PURE__*/t.literal("auto"), /*#__PURE__*/t.literal("none")]),
  relativeTimeFrame: /*#__PURE__*/t.union([/*#__PURE__*/t.literal("auto"), /*#__PURE__*/t.literal("none"), /*#__PURE__*/t.type({
    duration: t.number,
    unit: TimeframeUnitCodec
  })]),
  topK: /*#__PURE__*/t.union([t.number, /*#__PURE__*/t.literal("auto")]),
  dataSources: /*#__PURE__*/t.array( /*#__PURE__*/t.type({
    dataSourceViewId: t.string,
    workspaceId: t.string,
    filter: DataSourceFilterCodec
  }))
});
var DustAppRunActionConfigurationSchema = /*#__PURE__*/t.type({
  type: /*#__PURE__*/t.literal("dust_app_run_configuration"),
  appWorkspaceId: t.string,
  appId: t.string
});
var TablesQueryActionConfigurationSchema = /*#__PURE__*/t.type({
  type: /*#__PURE__*/t.literal("tables_query_configuration"),
  tables: /*#__PURE__*/t.array( /*#__PURE__*/t.type({
    dataSourceViewId: t.string,
    tableId: t.string,
    workspaceId: t.string
  }))
});
var WebsearchActionConfigurationSchema = /*#__PURE__*/t.type({
  type: /*#__PURE__*/t.literal("websearch_configuration")
});
var BrowseActionConfigurationSchema = /*#__PURE__*/t.type({
  type: /*#__PURE__*/t.literal("browse_configuration")
});
var GithubGetPullRequestActionConfigurationSchema = /*#__PURE__*/t.type({
  type: /*#__PURE__*/t.literal("github_get_pull_request_configuration")
});
var GithubCreateIssueActionConfigurationSchema = /*#__PURE__*/t.type({
  type: /*#__PURE__*/t.literal("github_create_issue_configuration")
});
var ReasoningActionConfigurationSchema = /*#__PURE__*/t.type({
  type: /*#__PURE__*/t.literal("reasoning_configuration"),
  modelId: ModelIdCodec,
  providerId: ModelProviderIdCodec,
  temperature: /*#__PURE__*/t.union([t.number, t["null"]]),
  reasoningEffort: /*#__PURE__*/t.union([ReasoningEffortCodec, t["null"]])
});
var ProcessActionConfigurationSchema = /*#__PURE__*/t.type({
  type: /*#__PURE__*/t.literal("process_configuration"),
  dataSources: /*#__PURE__*/t.array( /*#__PURE__*/t.type({
    dataSourceViewId: t.string,
    workspaceId: t.string,
    filter: DataSourceFilterCodec
  ...
  schema: /*#__PURE__*/t.array( /*#__PURE__*/t.type({
    name: t.string,
    type: /*#__PURE__*/t.union([/*#__PURE__*/t.literal("string"), /*#__PURE__*/t.literal("number"), /*#__PURE__*/t.literal("boolean")]),
    description: t.string
  }))
});
var multiActionsCommonFields = {
  name: /*#__PURE__*/t.union([t.string, t["null"]]),
  description: /*#__PURE__*/t.union([t.string, t["null"]])
};
var requiredMultiActionsCommonFields = /*#__PURE__*/t.type({
  name: t.string,
  description: /*#__PURE__*/t.union([t.string, t["null"]])
});
var ActionConfigurationSchema = /*#__PURE__*/t.intersection([/*#__PURE__*/t.union([RetrievalActionConfigurationSchema, DustAppRunActionConfigurationSchema, TablesQueryActionConfigurationSchema, ProcessActionConfigurationSchema, WebsearchActionConfigurationSchema, BrowseActionConfigurationSchema, GithubGetPullRequestActionConfigurationSchema, GithubCreateIssueActionConfigurationSchema, ReasoningActionConfigurationSchema]), requiredMultiActionsCommonFields]);
var ModelConfigurationSchema = /*#__PURE__*/t.intersection([/*#__PURE__*/t.type({
  modelId: ModelIdCodec,
  providerId: ModelProviderIdCodec,
...
t.partial(multiActionsCommonFields), /*#__PURE__*/t.partial({
  reasoningEffort: ReasoningEffortCodec
})]);
var IsSupportedModelSchema = /*#__PURE__*/new t.Type("SupportedModel", isSupportedModel, function (i, c) {
  return isSupportedModel(i) ? t.success(i) : t.failure(i, c);
}, t.identity);
var PostOrPatchAgentConfigurationRequestBodySchema = /*#__PURE__*/t.type({
  assistant: /*#__PURE__*/t.type({
    name: t.string,
    description: t.string,
    instructions: /*#__PURE__*/t.union([t.string, t["null"]]),
    pictureUrl: t.string,
    status: /*#__PURE__*/t.union([/*#__PURE__*/t.literal("active"), /*#__PURE__*/t.literal("archived"), /*#__PURE__*/t.literal("draft")]),
    scope: /*#__PURE__*/t.union([/*#__PURE__*/t.literal("workspace"), /*#__PURE__*/t.literal("published"), /*#__PURE__*/t.literal("private")]),
    model: /*#__PURE__*/t.intersection([ModelConfigurationSchema, IsSupportedModelSchema]),
    actions: /*#__PURE__*/t.array(ActionConfigurationSchema),
    templateId: /*#__PURE__*/t.union([t.string, t["null"], t.undefined]),
    maxStepsPerRun: /*#__PURE__*/t.union([t.number, t.undefined]),
...
var InternalPostMessagesRequestBodySchema = /*#__PURE__*/t.type({
  content: t.string,
  mentions: /*#__PURE__*/t.array( /*#__PURE__*/t.type({
    configurationId: t.string
  })),
  context: /*#__PURE__*/t.type({
    timezone: t.string,
    profilePictureUrl: /*#__PURE__*/t.union([t.string, t["null"]])
  })
});
var ContentFragmentBaseSchema = /*#__PURE__*/t.intersection([/*#__PURE__*/t.type({
  title: t.string
}), /*#__PURE__*/t.partial({
  url: /*#__PURE__*/t.union([t.string, t["null"]]),
  supersededContentFragmentId: /*#__PURE__*/t.union([t.string, t["null"]])
})]);
var getSupportedInlinedContentType = function getSupportedInlinedContentType() {
  ...
  return t.union([t.literal(first), t.literal(second)].concat(rest.map(function (value) {
    return t.literal(value);
  })));
};
var ContentFragmentInputWithFileIdSchema = /*#__PURE__*/t.intersection([ContentFragmentBaseSchema, /*#__PURE__*/t.type({
  fileId: t.string
})]);
function isContentFragmentInputWithContentType(fragment) {
  return "contentType" in fragment;
}
var InternalPostContentFragmentRequestBodySchema = /*#__PURE__*/t.intersection([/*#__PURE__*/t.type({
  context: /*#__PURE__*/t.type({
    profilePictureUrl: /*#__PURE__*/t.union([t.string, t["null"]])
  })
}), ContentFragmentInputWithFileIdSchema]);
var InternalPostConversationsRequestBodySchema = /*#__PURE__*/t.type({
  title: /*#__PURE__*/t.union([t.string, t["null"]]),
  visibility: /*#__PURE__*/t.union([/*#__PURE__*/t.literal("unlisted"), /*#__PURE__*/t.literal("workspace"), /*#__PURE__*/t.literal("deleted"), /*#__PURE__*/t.literal("test")]),
  message: /*#__PURE__*/t.union([InternalPostMessagesRequestBodySchema, t["null"]]),
  contentFragments: /*#__PURE__*/t.array(InternalPostContentFragmentRequestBodySchema)
});
var InternalPostBuilderSuggestionsRequestBodySchema = /*#__PURE__*/t.union([/*#__PURE__*/t.type({
  type: /*#__PURE__*/t.literal("name"),
  inputs: /*#__PURE__*/t.type({
    instructions: t.string,
    description: t.string
  })
}), /*#__PURE__*/t.type({
  type: /*#__PURE__*/t.literal("emoji"),
  inputs: /*#__PURE__*/t.type({
    instructions: t.string
  })
}), /*#__PURE__*/t.type({
  type: /*#__PURE__*/t.literal("instructions"),
  inputs: /*#__PURE__*/t.type({
    current_instructions: t.string,
    former_suggestions: /*#__PURE__*/t.array(t.string)
  })
}), /*#__PURE__*/t.type({
  type: /*#__PURE__*/t.literal("description"),
  inputs: /*#__PURE__*/t.type({
    instructions: t.string,
    name: t.string
  })
})]);
var BuilderSuggestionsResponseBodySchema = /*#__PURE__*/t.union([/*#__PURE__*/t.type({
  status: /*#__PURE__*/t.literal("ok"),
  suggestions: /*#__PURE__*/t.union([/*#__PURE__*/t.array(t.string), t["null"], t.undefined])
}), /*#__PURE__*/t.type({
  status: /*#__PURE__*/t.literal("unavailable"),
  reason: /*#__PURE__*/t.union([/*#__PURE__*/t.literal("user_not_finished"),
  /*#__PURE__*/
  // The user has not finished inputing data for suggestions to make sense
  t.literal("irrelevant")])
})]);
var BuilderEmojiSuggestionsResponseBodySchema = /*#__PURE__*/t.type({
  suggestions: /*#__PURE__*/t.array( /*#__PURE__*/t.type({
    emoji: t.string,
    backgroundColor: t.string
  }))
});
var InternalPostBuilderProcessActionGenerateSchemaRequestBodySchema = /*#__PURE__*/t.type({
  instructions: t.string
});

var PostRestrictedSpace = /*#__PURE__*/t.type({
  memberIds: /*#__PURE__*/t.array(t.string),
  isRestricted: /*#__PURE__*/t.literal(true)
});
var PostUnrestrictedSpace = /*#__PURE__*/t.type({
  memberIds: t["null"],
  isRestricted: /*#__PURE__*/t.literal(false)
});
var PostSpaceRequestBodySchema = /*#__PURE__*/t.intersection([/*#__PURE__*/t.type({
  name: t.string
}), /*#__PURE__*/t.union([PostRestrictedSpace, PostUnrestrictedSpace])]);
var PatchSpaceMembersRequestBodySchema = /*#__PURE__*/t.union([PostRestrictedSpace, PostUnrestrictedSpace]);
var ContentSchema = /*#__PURE__*/t.type({
  dataSourceId: t.string,
  parentsIn: /*#__PURE__*/t.array(t.string)
});
var PatchSpaceRequestBodySchema = /*#__PURE__*/t.type({
  name: /*#__PURE__*/t.union([t.string, t.undefined]),
  content: /*#__PURE__*/t.union([/*#__PURE__*/t.array(ContentSchema), t.undefined])
});
var PostDataSourceViewSchema = ContentSchema;
var PostNotionSyncPayloadSchema = /*#__PURE__*/t.type({
  urls: /*#__PURE__*/t.array(t.string),
  method: /*#__PURE__*/t.union([/*#__PURE__*/t.literal("sync"), /*#__PURE__*/t.literal("delete")])
});
var GetPostNotionSyncResponseBodySchema = /*#__PURE__*/t.type({
  syncResults: /*#__PURE__*/t.array( /*#__PURE__*/t.intersection([/*#__PURE__*/t.type({
    url: t.string,
    method: /*#__PURE__*/t.union([/*#__PURE__*/t.literal("sync"), /*#__PURE__*/t.literal("delete")]),
    timestamp: t.number,
    success: t["boolean"]
...
var UpsertContextSchema = /*#__PURE__*/t.type({
  sync_type: /*#__PURE__*/t.union([/*#__PURE__*/t.literal("batch"), /*#__PURE__*/t.literal("incremental"), t.undefined])
});
var FrontDataSourceDocumentSection = /*#__PURE__*/t.recursion("Section", function () {
  return t.type({
...
var PostDataSourceDocumentRequestBodySchema = /*#__PURE__*/t.type({
  timestamp: /*#__PURE__*/t.union([t.Int, t.undefined, t["null"]]),
  tags: /*#__PURE__*/t.union([/*#__PURE__*/t.array(t.string), t.undefined, t["null"]]),
  parent_id: /*#__PURE__*/t.union([t.string, t.undefined, t["null"]]),
  parents: /*#__PURE__*/t.union([/*#__PURE__*/t.array(t.string), t.undefined, t["null"]]),
  source_url: /*#__PURE__*/t.union([t.string, t.undefined, t["null"]]),
  upsert_context: /*#__PURE__*/t.union([UpsertContextSchema, t.undefined, t["null"]]),
  text: /*#__PURE__*/t.union([t.string, t.undefined, t["null"]]),
  section: /*#__PURE__*/t.union([FrontDataSourceDocumentSection, t.undefined, t["null"]]),
  light_document_output: /*#__PURE__*/t.union([t["boolean"], t.undefined]),
  async: /*#__PURE__*/t.union([t["boolean"], t.undefined, t["null"]]),
  title: t.string,
  mime_type: t.string
});
var PostDataSourceWithNameDocumentRequestBodySchema = /*#__PURE__*/t.intersection([/*#__PURE__*/t.type({
  name: t.string
}), PostDataSourceDocumentRequestBodySchema]);
var PatchDataSourceTableRequestBodySchema = /*#__PURE__*/t.type({
  name: t.string,
  description: t.string,
  timestamp: /*#__PURE__*/t.union([t.number, t.undefined, t["null"]]),
  tags: /*#__PURE__*/t.union([/*#__PURE__*/t.array(t.string), t.undefined, t["null"]]),
  parentId: /*#__PURE__*/t.union([t.string, t.undefined, t["null"]]),
  parents: /*#__PURE__*/t.union([/*#__PURE__*/t.array(t.string), t.undefined, t["null"]]),
  truncate: t["boolean"],
  async: /*#__PURE__*/t.union([t["boolean"], t.undefined]),
  fileId: /*#__PURE__*/t.union([t.string, t.undefined]),
  title: t.string,
  mimeType: t.string,
  sourceUrl: /*#__PURE__*/t.union([t.string, t.undefined, t["null"]])
});

var ParentsToAddRemoveSchema = /*#__PURE__*/t.type({
  parentsToAdd: /*#__PURE__*/t.union([/*#__PURE__*/t.array(t.string), t.undefined]),
  parentsToRemove: /*#__PURE__*/t.union([/*#__PURE__*/t.array(t.string), t.undefined])
});
var ParentsInSchema = /*#__PURE__*/t.type({
  parentsIn: /*#__PURE__*/t.array(t.string)
});
var PatchDataSourceViewSchema = /*#__PURE__*/t.union([ParentsToAddRemoveSchema, ParentsInSchema]);
...
var BrowseResultSchema = /*#__PURE__*/t.type({
...
var BrowseActionOutputSchema = /*#__PURE__*/t.type({
  results: /*#__PURE__*/t.array(BrowseResultSchema)
});
...
var PlatformActionsProviders = ["github"];
...
function isGithubGetPullRequestConfiguration(arg) {
  return !!arg && typeof arg === "object" && "type" in arg && arg.type === "github_get_pull_request_configuration";
}
function isGithubGetPullRequestActionType(arg) {
  return arg.type === "github_get_pull_request_action";
}
function isGithubCreateIssueConfiguration(arg) {
  return !!arg && typeof arg === "object" && "type" in arg && arg.type === "github_create_issue_configuration";
}
function isGithubCreateIssueActionType(arg) {
...
function getTablesQueryResultsFileAttachment(_ref2) {
  var resultsFileId = _ref2.resultsFileId,
    resultsFileSnippet = _ref2.resultsFileSnippet,
    output = _ref2.output,
    _ref2$includeSnippet = _ref2.includeSnippet,
    includeSnippet = _ref2$includeSnippet === void 0 ? true : _ref2$includeSnippet;
  if (!resultsFileId || !resultsFileSnippet) {
    return null;
  }
  var attachment = "<file " + ("id=\"" + resultsFileId + "\" type=\"text/csv\" title=" + getTablesQueryResultsFileTitle({
    output: output
  }));
  if (!includeSnippet) {
    return attachment + " />";
...
var WebsearchAppResultSchema = /*#__PURE__*/t.type({
  title: t.string,
  snippet: t.string,
  link: t.string
});
var WebsearchAppActionOutputSchema = /*#__PURE__*/t.union([/*#__PURE__*/t.type({
  results: /*#__PURE__*/t.array(WebsearchAppResultSchema)
}), /*#__PURE__*/t.type({
  error: t.string,
  results: /*#__PURE__*/t.array(WebsearchAppResultSchema)
})]);
// Type after processing in the run loop (to add references)
var WebsearchResultSchema = /*#__PURE__*/t.type({
  title: t.string,
  snippet: t.string,
  link: t.string,
  reference: t.string
});
var WebsearchActionOutputSchema = /*#__PURE__*/t.union([/*#__PURE__*/t.type({
  results: /*#__PURE__*/t.array(WebsearchResultSchema)
}), /*#__PURE__*/t.type({
  results: /*#__PURE__*/t.array(WebsearchResultSchema),
  error: t.string
})]);
...
var TemplateTagCodeTypeCodec = /*#__PURE__*/t.keyof( /*#__PURE__*/_extends({}, TEMPLATES_TAGS_CONFIG));
...
var TemplateActionTypePreset = /*#__PURE__*/t.type({
  type: MultiActionPresetCodec,
  name: NonEmptyString,
  description: NonEmptyString,
  help: NonEmptyString
});
var TemplateActionsPreset = /*#__PURE__*/t.array(TemplateActionTypePreset);
// VISIBILITY
...
// FORM SCHEMA
var CreateTemplateFormSchema = /*#__PURE__*/t.type({
  backgroundColor: NonEmptyString,
  description: /*#__PURE__*/t.union([t.string, t.undefined]),
  emoji: NonEmptyString,
  handle: NonEmptyString,
  timeFrameDuration: /*#__PURE__*/t.union([t.string, t.undefined]),
  timeFrameUnit: /*#__PURE__*/t.union([TimeframeUnitCodec, /*#__PURE__*/t.literal(""), t.undefined]),
  helpActions: /*#__PURE__*/t.union([t.string, t.undefined]),
  helpInstructions: /*#__PURE__*/t.union([t.string, t.undefined]),
  presetActions: TemplateActionsPreset,
  presetInstructions: /*#__PURE__*/t.union([t.string, t.undefined]),
  presetModelId: t.string,
  presetTemperature: AssistantCreativityLevelCodec,
  tags: /*#__PURE__*/nonEmptyArray(TemplateTagCodeTypeCodec),
...
var ActionResponseBaseSchema = /*#__PURE__*/t.type({
  run_id: t.string,
  created: t.Integer,
  run_type: t.string,
  config: t.UnknownRecord,
  status: /*#__PURE__*/t.type({
    run: t.string,
    blocks: /*#__PURE__*/t.array( /*#__PURE__*/t.type({
      block_type: t.string,
      name: t.string,
      status: t.string,
...
var ConnectorsAPI = /*#__PURE__*/function () {
  ...
  _proto.getConnectorPermissions = /*#__PURE__*/function () {
    var _getConnectorPermissions = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(_ref4) {
      var connectorId, filterPermission, parentId, _ref4$viewType, viewType, queryParams, qs, url, res, response;
...
var CoreAPISearchScopeSchema = /*#__PURE__*/t.union([/*#__PURE__*/t.literal("nodes_titles"), /*#__PURE__*/t.literal("data_source_name"), /*#__PURE__*/t.literal("both")]);
var CoreAPIDatasourceViewFilterSchema = /*#__PURE__*/t.intersection([/*#__PURE__*/t.type({
  data_source_id: t.string,
  view_filter: /*#__PURE__*/t.array(t.string)
}), /*#__PURE__*/t.partial({
  search_scope: CoreAPISearchScopeSchema
})]);
// Edge-ngram starts at 2 characters.
var MIN_SEARCH_QUERY_SIZE = 2;
var CoreAPINodesSearchFilterSchema = /*#__PURE__*/t.intersection([/*#__PURE__*/t.type({
  data_source_views: /*#__PURE__*/t.array(CoreAPIDatasourceViewFilterSchema)
}), /*#__PURE__*/t.partial({
  excluded_node_mime_types: /*#__PURE__*/t.union([/*#__PURE__*/t.readonlyArray(t.string), t.undefined]),
  node_ids: /*#__PURE__*/t.array(t.string),
  node_types: /*#__PURE__*/t.array(t.string),
  parent_id: t.string,
  query: t.string
})]);
  ...
  for (var _i = 0, _Object$entries = Object.entries(args); _i < _Object$entries.length; _i++) {
    ...
    switch (arg.type) {
      ...
      case "enum":
        ...
        codecProps[key] = t.union([t.literal(arg.values[0]), t.literal(arg.values[1])].concat(arg.values.slice(2).map(function (v) {
          return t.literal(v);
        })));
    }
  }
...
var RoleSchema = /*#__PURE__*/t.keyof( /*#__PURE__*/keyObject(ROLES));
var ActiveRoleSchema = /*#__PURE__*/t.keyof( /*#__PURE__*/keyObject(ACTIVE_ROLES));
...
var InviteMemberFormSchema = /*#__PURE__*/t.type({
  email: NonEmptyString$1,
...
var CreatePlanFormSchema = /*#__PURE__*/t.type({
  code: NonEmptyString,
  name: NonEmptyString,
  ...
  maxMessages: /*#__PURE__*/t.union([t.number, NumberFromString]),
  maxMessagesTimeframe: /*#__PURE__*/t.keyof({
    day: null,
    lifetime: null
  }),
  dataSourcesCount: /*#__PURE__*/t.union([t.number, NumberFromString]),
  dataSourcesDocumentsCount: /*#__PURE__*/t.union([t.number, NumberFromString]),
  dataSourcesDocumentsSizeMb: /*#__PURE__*/t.union([t.number, NumberFromString]),
  maxUsers: /*#__PURE__*/t.union([t.number, NumberFromString]),
  maxVaults: /*#__PURE__*/t.union([t.number, NumberFromString])
});
var EnterpriseUpgradeFormSchema = /*#__PURE__*/t.type({
...
// Credentials
var SnowflakeCredentialsSchema = /*#__PURE__*/t.type({
  username: t.string,
  password: t.string,
  account: t.string,
  role: t.string,
...
var CheckBigQueryCredentialsSchema = /*#__PURE__*/t.type({
  type: t.string,
  project_id: t.string,
...
var BigQueryCredentialsWithLocationSchema = /*#__PURE__*/t.type({
  type: t.string,
  project_id: t.string,
  private_key_id: t.string,
  private_key: t.string,
...
var ApiKeyCredentialsSchema = /*#__PURE__*/t.type({
  api_key: t.string
});
var SalesforceCredentialsSchema = /*#__PURE__*/t.type({
  client_id: t.string,
          ...
          return _context.abrupt("return", new Promise(function (resolve) {
            ...
            var popupMessageEventListener = function popupMessageEventListener(event) {
              ...
              if (event.data.type === "connection_finalized") {
                authComplete = true;
                var connection = event.data.connection;
...
function transformStream(input, prefix, pageSelector) {
  ...
  var htmlParsingTransform = new Transform({
    objectMode: true,
    ...
    onclosetag: function onclosetag(name) {
      ...
      if (name !== lastTag) {
        ...
        if (lastTag === HTML_TAGS.ROW) {
          var csv = stringify([state.currentRow]);
...
var TikaResponseCodec = /*#__PURE__*/t.type({
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          ...
          case 9:
            ...
            if (!isLeft$1(decodedReponse)) {
              _context3.next = 14;
              break;
            }
            pathError = reporter.formatValidationErrors(decodedReponse.left);
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 36:
          ...
          throw new ParsingCsvError(_context2.t1 instanceof CsvError ? "Unable to parse CSV string : " + _context2.t1.message : "Unable to parse CSV string");
        case 39:
...
export { ACTION_RUNNING_LABELS, ACTIVE_ROLES, AGENT_CONFIGURATION_SCOPES, APP_NAME_REGEXP, ASSISTANT_BUILDER_DRAWER_TABS, ASSISTANT_CREATIVITY_LEVELS, ASSISTANT_CREATIVITY_LEVEL_DISPLAY_NAMES, ASSISTANT_CREATIVITY_LEVEL_TEMPERATURES, ActionResponseBaseSchema, ActiveRoleSchema, AdminCommandSchema, AdminResponseSchema, AdminSuccessResponseSchema, ApiKeyCredentialsSchema, AssistantCreativityLevelCodec, BaseAction, BatchAllResponseSchema, BatchCommandSchema, BigQueryCredentialsWithLocationSchema, BrowseActionOutputSchema, BrowseResultSchema, BuilderEmojiSuggestionsResponseBodySchema, BuilderSuggestionsResponseBodySchema, CLAUDE_2_1_MODEL_ID, CLAUDE_2_DEFAULT_MODEL_CONFIG, CLAUDE_3_5_HAIKU_20241022_MODEL_ID, CLAUDE_3_5_HAIKU_DEFAULT_MODEL_CONFIG, CLAUDE_3_5_SONNET_20240620_DEPRECATED_MODEL_CONFIG, CLAUDE_3_5_SONNET_20240620_MODEL_ID, CLAUDE_3_5_SONNET_20241022_MODEL_ID, CLAUDE_3_5_SONNET_DEFAULT_MODEL_CONFIG, CLAUDE_3_7_SONNET_20250219_MODEL_ID, CLAUDE_3_7_SONNET_DEFAULT_MODEL_CONFIG, CLAUDE_3_HAIKU_20240307_MODEL_ID, CLAUDE_3_HAIKU_DEFAULT_MODEL_CONFIG, CLAUDE_3_OPUS_2024029_MODEL_ID, CLAUDE_3_OPUS_DEFAULT_MODEL_CONFIG, CLAUDE_INSTANT_1_2_MODEL_ID, CLAUDE_INSTANT_DEFAULT_MODEL_CONFIG, CONNECTORS_ERROR_TYPES, CONNECTOR_PROVIDERS, CREDENTIALS_PROVIDERS, CheckBigQueryCredentialsSchema, CheckFileGenericResponseSchema, ConfluenceClientError, ConfluenceCommandSchema, ConfluenceMeResponseSchema, ConfluenceUpsertPageResponseSchema, ConnectorConfigurationTypeSchema, ConnectorCreateRequestBodySchema, ConnectorsAPI, ConnectorsCommandSchema, ContentNodesViewTypeCodec, ContentSchema, ConversationError, CoreAPI, CoreAPIDatasourceViewFilterSchema, CoreAPINodesSearchFilterSchema, CoreAPISearchScopeSchema, CrawlingFrequencies, CrawlingModes, CreatePlanFormSchema, CreateTemplateFormSchema, DATA_SOURCE_VIEW_CATEGORIES, DEEPSEEK_CHAT_MODEL_CONFIG, DEEPSEEK_CHAT_MODEL_ID, DEEPSEEK_REASONER_MODEL_CONFIG, DEEPSEEK_REASONER_MODEL_ID, DEFAULT_EMBEDDING_PROVIDER_ID, DEFAULT_MAX_STEPS_USE_PER_RUN, DEFAULT_QDRANT_CLUSTER, DEPTH_DISPLAY_TEXT, DepthOptions, EMBEDDING_CONFIGS, EMBEDDING_PROVIDER_IDS, EXCLUDE_DATABASES, EXCLUDE_SCHEMAS, EmbeddingProviderCodec, EnterpriseUpgradeFormSchema, EnvironmentConfig, Err, FIREWORKS_DEEPSEEK_R1_MODEL_CONFIG, FIREWORKS_DEEPSEEK_R1_MODEL_ID, FREQUENCY_DISPLAY_TEXT, FrontDataSourceDocumentSection, GEMINI_1_5_FLASH_LATEST_MODEL_ID, GEMINI_1_5_PRO_LATEST_MODEL_ID, GEMINI_2_FLASH_LITE_PREVIEW_MODEL_CONFIG, GEMINI_2_FLASH_LITE_PREVIEW_MODEL_ID, GEMINI_2_FLASH_MODEL_CONFIG, GEMINI_2_FLASH_MODEL_ID, GEMINI_2_FLASH_PREVIEW_MODEL_CONFIG, GEMINI_2_FLASH_PREVIEW_MODEL_ID, GEMINI_2_FLASH_THINKING_PREVIEW_MODEL_CONFIG, GEMINI_2_FLASH_THINKING_PREVIEW_MODEL_ID, GEMINI_2_PRO_PREVIEW_MODEL_CONFIG, GEMINI_2_PRO_PREVIEW_MODEL_ID, GEMINI_FLASH_DEFAULT_MODEL_CONFIG, GEMINI_PRO_DEFAULT_MODEL_CONFIG, GLOBAL_AGENTS_SID, GPT_3_5_TURBO_MODEL_CONFIG, GPT_3_5_TURBO_MODEL_ID, GPT_4O_20240806_MODEL_CONFIG, GPT_4O_20240806_MODEL_ID, GPT_4O_MINI_MODEL_CONFIG, GPT_4O_MINI_MODEL_ID, GPT_4O_MODEL_CONFIG, GPT_4O_MODEL_ID, GPT_4_TURBO_MODEL_CONFIG, GPT_4_TURBO_MODEL_ID, GROUP_KINDS, GetAgentConfigurationsHistoryQuerySchema, GetAgentConfigurationsLeaderboardQuerySchema, GetAgentConfigurationsQuerySchema, GetParentsResponseSchema, GetPostNotionSyncResponseBodySchema, GithubCommandSchema, GoogleDriveCommandSchema, IntercomCheckConversationResponseSchema, IntercomCheckMissingConversationsResponseSchema, IntercomCheckTeamsResponseSchema, IntercomCommandSchema, IntercomFetchArticlesResponseSchema, IntercomFetchConversationResponseSchema, IntercomForceResyncArticlesResponseSchema, InternalPostBuilderProcessActionGenerateSchemaRequestBodySchema, InternalPostBuilderSuggestionsRequestBodySchema, InternalPostContentFragmentRequestBodySchema, InternalPostConversationsRequestBodySchema, InternalPostMessagesRequestBodySchema, InvalidStructuredDataHeaderError, InviteMemberFormSchema, MAX_CHUNK_SIZE, MAX_FILE_SIZES, MAX_MESSAGE_TIMEFRAMES, MAX_STEPS_USE_PER_RUN_LIMIT, MEMBERSHIP_ROLE_TYPES, MIME_TYPES, MIN_SEARCH_QUERY_SIZE, MISTRAL_CODESTRAL_MODEL_CONFIG, MISTRAL_CODESTRAL_MODEL_ID, MISTRAL_LARGE_MODEL_CONFIG, MISTRAL_LARGE_MODEL_ID, MISTRAL_MEDIUM_MODEL_CONFIG, MISTRAL_MEDIUM_MODEL_ID, MISTRAL_SMALL_MODEL_CONFIG, MISTRAL_SMALL_MODEL_ID, MODEL_IDS, MODEL_PROVIDER_IDS, MULTI_ACTION_PRESETS, MicrosoftCommandSchema, ModelIdCodec, ModelProviderIdCodec, MultiActionPresetCodec, NotionCheckUrlResponseSchema, NotionCommandSchema, NotionDeleteUrlResponseSchema, NotionFindUrlResponseSchema, NotionMeResponseSchema, NotionSearchPagesResponseSchema, NotionUpsertResponseSchema, NumberAsStringCodec, O1_HIGH_REASONING_MODEL_CONFIG, O1_MINI_MODEL_CONFIG, O1_MINI_MODEL_ID, O1_MODEL_CONFIG, O1_MODEL_ID, O3_MINI_HIGH_REASONING_MODEL_CONFIG, O3_MINI_MODEL_CONFIG, O3_MINI_MODEL_ID, OAUTH_PROVIDERS, OAUTH_USE_CASES, OAuthAPI, Ok, PROCESS_ACTION_TOP_K, PROCESS_SCHEMA_ALLOWED_TYPES, PROVIDERS_WITH_WORKSPACE_CONFIGURATIONS, ParsedNotionDatabaseSchema, PatchDataSourceTableRequestBodySchema, PatchDataSourceViewSchema, PatchSpaceMembersRequestBodySchema, PatchSpaceRequestBodySchema, PlatformActionsProviders, PostDataSourceDocumentRequestBodySchema, PostDataSourceViewSchema, PostDataSourceWithNameDocumentRequestBodySchema, PostNotionSyncPayloadSchema, PostOrPatchAgentConfigurationRequestBodySchema, PostSpaceRequestBodySchema, RATE_LIMITER_PREFIX, REASONING_EFFORT_IDS, ROLES, RateLimitError, ReasoningEffortCodec, RoleSchema, SUBSCRIPTION_STATUSES, SUPPORTED_MODEL_CONFIGS, SUPPORTED_OPERATIONS, SalesforceCredentialsSchema, SlackCommandSchema, SlackConfigurationTypeSchema, SlugifiedString, SnowflakeCredentialsSchema, TABLE_PREFIX, TEMPLATES_TAGS_CONFIG, TEMPLATES_TAG_CODES, TEMPLATE_VISIBILITIES, TIME_FRAME_UNITS, TOGETHERAI_DEEPSEEK_R1_MODEL_CONFIG, TOGETHERAI_DEEPSEEK_R1_MODEL_ID, TOGETHERAI_DEEPSEEK_V3_MODEL_CONFIG, TOGETHERAI_DEEPSEEK_V3_MODEL_ID, TOGETHERAI_LLAMA_3_3_70B_INSTRUCT_TURBO_MODEL_CONFIG, TOGETHERAI_LLAMA_3_3_70B_INSTRUCT_TURBO_MODEL_ID, TOGETHERAI_QWEN_2_5_CODER_32B_INSTRUCT_MODEL_CONFIG, TOGETHERAI_QWEN_2_5_CODER_32B_INSTRUCT_MODEL_ID, TOGETHERAI_QWEN_72B_INSTRUCT_MODEL_CONFIG, TOGETHERAI_QWEN_72B_INSTRUCT_MODEL_ID, TOGETHERAI_QWEN_QWQ_32B_PREVIEW_MODEL_CONFIG, TOGETHERAI_QWEN_QWQ_32B_PREVIEW_MODEL_ID, TRACKER_FREQUENCIES, TemplateVisibilityCodec, TemporalCheckQueueResponseSchema, TemporalCommandSchema, TemporalUnprocessedWorkflowsResponseSchema, TextExtraction, TimeframeUnitCodec, UNIQUE_SPACE_KINDS, UpdateConnectorConfigurationTypeSchema, UpdateConnectorRequestBodySchema, UpsertContextSchema, WEBCRAWLER_DEFAULT_CONFIGURATION, WEBCRAWLER_MAX_DEPTH, WEBCRAWLER_MAX_PAGES, WHITELISTABLE_FEATURES, WebCrawlerConfigurationTypeSchema, WebCrawlerHeaderRedactedValue, WebcrawlerCommandSchema, WebsearchActionOutputSchema, WebsearchAppActionOutputSchema, ZendeskCheckIsAdminResponseSchema, ZendeskCommandSchema, ZendeskCountTicketsResponseSchema, ZendeskFetchBrandResponseSchema, ZendeskFetchTicketResponseSchema, assertNever, cacheWithRedis, compareAgentsForSort, concurrentExecutor, connectionStrategyToHumanReadable, contentTypeForExtension, createIoTsCodecFromArgs, createRangeCodec, credentialsFromProviders, decrypt, defaultSelectionConfiguration, dustManagedCredentials, encrypt, ensureFileSize, errorToString, expireRateLimiterKey, extensionsForContentType, formatUserFullName, generateTailwindBackgroundColors, getConnectionCredentials, getDustAppRunResultsFileTitle, getFileFormatCategory, getGlobalAgentAuthorName, getGoogleIdsFromSheetContentNodeInternalId, getGoogleSheetContentNodeInternalId, getGoogleSheetTableId, getGroupIdsFromHeaders, getHeaderFromGroupIds, getHeaderFromUserEmail, getIntercomSyncWorkflowId, getLargeWhitelistedModel, getNotionDatabaseTableId, getNotionDatabaseTableIdFromContentNodeInternalId, getNotionWorkflowId, getOAuthConnectionAccessToken, getProviderFromRetrievedDocument, getSanitizedHeaders, getSmallWhitelistedModel, getSupportedFileExtensions, getSupportedInlinedContentType, getSupportedNonImageFileExtensions, getSupportedNonImageMimeTypes, getTablesQueryResultsFileAttachment, getTablesQueryResultsFileTitle, getTimeframeSecondsFromLiteral, getTitleFromRetrievedDocument, getUserEmailFromHeaders, getZendeskGarbageCollectionWorkflowId, getZendeskSyncWorkflowId, googleDriveIncrementalSyncWorkflowId, guessDelimiter, hasRolePermissions, ioTsEnum, ioTsParsePayload, isAPIErrorResponse, isActionResponseBase, isActiveRoleType, isAdmin, isAgentMention, isAgentMessageType, isBaseActionClass, isBigFileSize, isBigQueryWithLocationCredentials, isBrowseActionType, isBrowseConfiguration, isBuilder, isConfluenceNotFoundError, isConnectorError, isConnectorProvider, isConnectorsAPIError, isContentFragmentInputWithContentType, isContentFragmentMessageTypeModel, isContentFragmentType, isConversationIncludeFileConfiguration, isConversationIncludeFileConfigurationActionType, isCoreAPIError, isCredentialProvider, isDataSourceNameValid, isDataSourceViewCategoryWithoutApps, isDepthOption, isDevelopment, isDisplayCodeRequest, isDownloadFileRequest, isDustAppRunActionType, isDustAppRunConfiguration, isDustWorkspace, isEmptyString, isGetCodeToExecuteRequest, isGetFileRequest, isGithubCreateIssueActionType, isGithubCreateIssueConfiguration, isGithubGetPullRequestActionType, isGithubGetPullRequestConfiguration, isGlobalGroupKind, isGoogleSheetContentNodeInternalId, isGroupKind, isMaxMessagesTimeframeType, isMembershipRoleType, isModelId, isModelProviderId, isModjoCredentials, isOAuthAPIError, isOAuthConnectionType, isOAuthProvider, isOAuthUseCase, isOnlyAdmin, isOnlyBuilder, isOnlyUser, isProcessActionType, isProcessConfiguration, isProviderWhitelisted, isProviderWithWorkspaceConfiguration, isPublicySupportedUseCase, isReasoningConfiguration, isRetrievalActionType, isRetrievalConfiguration, isRowMatchingSchema, isSalesforceCredentials, isSearchLabelsConfiguration, isSetContentHeightRequest, isSetErrorMessageRequest, isSlackAutoReadPatterns, isSlackbotWhitelistType, isSlugified, isSnowflakeCredentials, isString, isSupportedDelimitedTextContentType, isSupportedEnterpriseConnectionStrategy, isSupportedFileContentType, isSupportedImageContentType, isSupportedModel, isSupportedResourceType, isSystemGroupKind, isTablesQueryActionType, isTablesQueryConfiguration, isTemplateTagCodeArray, isTextContent, isTextExtractionSupportedContentType, isTimeFrame, isUniqueSpaceKind, isUser, isUserMessageType, isUserMessageTypeModel, isValidContentNodesViewType, isValidDataSourceViewCategory, isValidDate, isValidSalesforceClientId, isValidSalesforceClientSecret, isValidSalesforceDomain, isValidZendeskSubdomain, isVisualizationRPCRequest, isWebCrawlerConfiguration, isWebsearchActionType, isWebsearchConfiguration, isWebsiteOrFolderCategory, isWhitelistableFeature, labsTranscriptsProviders, makeConfluenceSyncWorkflowId, maxFileSizeToHumanReadable, md5, microsoftGarbageCollectionWorkflowId, microsoftIncrementalSyncWorkflowId, normalizeError, pagePrefixesPerMimeType, parseAndStringifyCsv, pluralize, prettifyGroupName, rateLimiter, redactString, removeNulls, renderSchemaPropertiesAsJSONSchema, safeParseJSON, safeSubstring, sanitizeString, sectionFullText, sendInitDbMessage, sendUserOperationMessage, setupGlobalErrorHandler, setupOAuthConnection, slugify, stripNullBytes, supportedEnterpriseConnectionStrategies, supportedResourceTypes, supportedUploadableContentType, throwIfInvalidAgentConfiguration, truncate, validCommands };
