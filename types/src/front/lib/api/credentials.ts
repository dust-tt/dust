...
export const dustManagedCredentials = (): CredentialsType => {
  return {
    ANTHROPIC_API_KEY: DUST_MANAGED_ANTHROPIC_API_KEY.trim(),
    AZURE_OPENAI_API_KEY: DUST_MANAGED_AZURE_OPENAI_API_KEY.trim(),
    AZURE_OPENAI_ENDPOINT: DUST_MANAGED_AZURE_OPENAI_ENDPOINT.trim(),
    MISTRAL_API_KEY: DUST_MANAGED_MISTRAL_API_KEY.trim(),
    OPENAI_API_KEY: DUST_MANAGED_OPENAI_API_KEY.trim(),
    TEXTSYNTH_API_KEY: DUST_MANAGED_TEXTSYNTH_API_KEY.trim(),
    GOOGLE_AI_STUDIO_API_KEY: DUST_MANAGED_GOOGLE_AI_STUDIO_API_KEY.trim(),
    SERP_API_KEY: DUST_MANAGED_SERP_API_KEY.trim(),
    BROWSERLESS_API_KEY: DUST_MANAGED_BROWSERLESS_API_KEY.trim(),
  };
};
