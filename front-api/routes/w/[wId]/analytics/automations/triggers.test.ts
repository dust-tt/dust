  ...
  triggers: [
    {
      ...
      kind: "schedule",
      agent: { agentId: "agent1", name: "deep-dive", pictureUrl: null },
      editor: { name: "Nic Siegle", pictureUrl: null },
    ...
    },
    {
      ...
      name: "Inbound triage",
      kind: "webhook",
      agent: { agentId: "agent2", name: "support", pictureUrl: null },
      editor: { name: "Adrien Simon", pictureUrl: null },
