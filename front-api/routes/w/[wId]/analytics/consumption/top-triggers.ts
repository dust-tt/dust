...
export type { GetConsumptionTopTriggersResponse };

// Mounted at /api/w/:wId/analytics/consumption/top-triggers.
// Also mounted at /api/w/:wId/me/analytics/consumption/top-triggers.
// Also mounted at /api/w/:wId/assistant/agent_configurations/:aId/analytics/consumption/top-triggers.
...
app.post(
  ...
  async (ctx): HandlerResult<GetConsumptionTopTriggersResponse> => {
    ...
    const result = await fetchConsumptionTopTriggers(auth, {
      period,
      limit,
      offset,
      search,
