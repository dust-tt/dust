...
describe("POST /api/v1/w/[wId]/files/[fileId]", () => {
  ...
  it("should return 403 without manager permissions on non-conversation files", async () => {
    ...
    // System keys always have admin permissions in real auth, so use a
...
describe("DELETE /api/v1/w/[wId]/files/[fileId]", () => {
  ...
  it("should allow system key to delete non-conversation files (system keys have admin permissions)", async () => {
    // System keys always have admin permissions in real auth, so they can
