...
BUILD_CMD=(gcloud builds submit --quiet --config "${SCRIPT_DIR}/cloudbuild.yaml" --service-account="projects/${PROJECT_ID}/serviceAccounts/cloudbuild-publisher@${PROJECT_ID}.iam.gserviceaccount.com")
