...
import * as activities from "@app/temporal/frame_og/activities";
...
export async function runFrameOgWorker() {
  ...
  const worker = await createTemporalWorker({
    ...
    // Keep concurrency low: each activity drives a Gotenberg Chromium session.
