...
import { resolveLegacyConsumptionExecutionContext } from "@app/temporal/agent_loop/activities/consumption";
    ...
    switch (event.type) {
      ...
      case "tool_success":
        ...
        void emitAuditLogEventDirect({
          ...
          // target: frame function tool calls share this action and have no agent.
          targets: [
