...
const activities: AgentLoopActivities = {
  runModelAndCreateActionsActivity: proxyActivities<typeof runModelAndCreateWrapperActivities>({
    startToCloseTimeout: "7 minutes", // 5 min for model + 2 min for create
