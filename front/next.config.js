...
const CONTENT_SECURITY_POLICIES = [
  ...
  `frame-src 'self' *.wistia.net eu.viz.dust.tt viz.dust.tt *.hsforms.net *.googletagmanager.com *.doubleclick.net *.default.com *.hsforms.com *.youtube.com *.youtube-nocookie.com${isDev ? " http://localhost:3007 http://localhost:3011" : ""} *.google.com docs.google.com drive.google.com view.officeapps.live.com${isDev ? " http://localhost:3007" : ""};`,
