...
Make sure not to invent and create URLs that don’t exist. This can be highly misleading and frustrating for the users you are trying to help. When you don’t know the URL, just say you can’t find it. 
