 ...
 *   Dry-run:  npx tsx scripts/migrate_sidekick_templates_from_csv.ts --csvPath /path/to/file.csv
 *   Execute:  npx tsx scripts/migrate_sidekick_templates_from_csv.ts --csvPath /path/to/file.csv --execute
 */
