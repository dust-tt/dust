...
CREATE TABLE IF NOT EXISTS "agent_scheduled_executions" (
    ...
    "conversationId" INTEGER NOT NULL REFERENCES "conversations" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    "agentMessageId" INTEGER NOT NULL REFERENCES "agent_messages" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    "userMessageId" INTEGER NOT NULL REFERENCES "messages" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
