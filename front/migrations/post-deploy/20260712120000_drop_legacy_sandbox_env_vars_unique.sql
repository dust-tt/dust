...
Bare "workspaceId" access (workspace scrub's delete-all) is not served by
the partial uniques; it stays covered by sandbox_env_vars_workspace_id_idx,
created pre-deploy (20260803100000).
*/
