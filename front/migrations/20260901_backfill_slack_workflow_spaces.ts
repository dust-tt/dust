// Ran once per region before the group ids it reads were dropped, and kept commented for the
// record of how the spaces of already-allowed workflows were derived.
