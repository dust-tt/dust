...
SET SESSION statement_timeout = 1200000;
SET SESSION lock_timeout = 3000;
CREATE UNIQUE INDEX CONCURRENTLY agent_message_consumption_items_unique_rounding ON public.agent_message_consumption_items USING btree ("workspaceId", "attributionVersion", "runKey") WHERE ("itemType" = 'rounding'::text);
