// Kept for reference. This script suspended the members of every group-managed space, a state
// that no longer exists: a space's members are now its manual list plus the members of its
// groups, and `20260904_end_suspended_group_memberships` ended the rows this one suspended.
//
