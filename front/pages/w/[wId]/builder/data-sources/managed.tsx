          ...
          <>
            ...
            <div className="flex flex-col gap-y-2">
              ...
              <div className="text-sm font-normal text-element-700">
                ...
                to Artificial Intelligence (AI) model providers, for the purpose
                of processing and analysis. This process is an integral part of
                the functionality of our service and is subject to the terms
