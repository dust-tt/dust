...
search code. Keep the guidance self-contained: define the document shape, add versioned mappings
and regional settings, register the alias, wire indexing/query helpers, and validate the resulting
index.
