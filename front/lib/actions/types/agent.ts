...
export type ServerSideAgentActionConfigurationType = Exclude<
  AgentActionConfigurationType,
  ClientSideMCPServerConfigurationType
>;

// Instead of SpecialUnsaved
export type UnsavedServerSideAgentActionConfigurationType = {
  [K in ServerSideAgentActionConfigurationType["type"]]: UnsavedConfiguration<
    Extract<ServerSideAgentActionConfigurationType, { type: K }>
  >;
}[ServerSideAgentActionConfigurationType["type"]];
