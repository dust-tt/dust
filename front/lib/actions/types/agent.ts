...
type PartialServerSideAgentActionConfigurationType =
  | Exclude<
...
export type UnsavedServerSideAgentActionConfigurationType = {
  [K in PartialServerSideAgentActionConfigurationType["type"]]: UnsavedConfiguration<
    Extract<PartialServerSideAgentActionConfigurationType, { type: K }>
  >;
}[PartialServerSideAgentActionConfigurationType["type"]];
