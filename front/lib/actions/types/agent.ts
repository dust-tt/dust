...
export function isUnsavedServerSideMCPServerConfigurationType(
  arg: UnsavedMCPServerConfigurationType
): arg is UnsavedServerSideMCPServerConfigurationType {
  return "mcpServerViewId" in arg;
}
