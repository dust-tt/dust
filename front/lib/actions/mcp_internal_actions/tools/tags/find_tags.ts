...
import { FIND_TAGS_TOOL_NAME } from "@app/lib/actions/mcp_internal_actions/server_constants";
...
export function makeFindTagsToolImplementation(
  auth: Authenticator,
  ...
  async function findTagsCallback({
    query,
    dataSources,
  }: z.infer<typeof FindTagsSchema>) {
