...
const FILESYSTEM_SEARCH_TOOL_DESCRIPTION =
...
export function registerSearchTool(
  ...
  server.tool(
    SEARCH_TOOL_NAME,
    FILESYSTEM_SEARCH_TOOL_DESCRIPTION,
    ...
    withToolLogging(
      ...
      async (params) => searchToolCallback(auth, agentLoopContext, params)
    )
  );
}

export function registerSearchToolWithDynamicTags(
  auth: Authenticator,
  server: McpServer,
  agentLoopContext: AgentLoopContextType | undefined
) {
  server.tool(
    ...
    withToolLogging(
      ...
      async (params) =>
        searchToolCallback(auth, agentLoopContext, params, {
...
async function searchToolCallback(
  auth: Authenticator,
  agentLoopContext: AgentLoopContextType | undefined,
