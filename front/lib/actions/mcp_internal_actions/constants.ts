...
export const INTERNAL_MCP_SERVERS = {
  ...
  google_drive: {
    ...
    tools_retry_policies: {
      list_drives: "retry_on_interrupt",
      search_files: "retry_on_interrupt",
      get_file_content: "retry_on_interrupt",
      get_spreadsheet: "retry_on_interrupt",
      get_worksheet: "retry_on_interrupt",
      list_comments: "retry_on_interrupt",
      get_document_structure: "retry_on_interrupt",
      get_presentation_structure: "retry_on_interrupt",
      list_file_permissions: "retry_on_interrupt",
    },
    timeoutMs: undefined,
