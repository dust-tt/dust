...
type ADFMark = z.infer<typeof ADFMarkSchema>;
...
type ADFTextNode = z.infer<typeof ADFTextNodeSchema>;

const ADFHardBreakNodeSchema = z.object({
  type: z.literal("hardBreak"),
});

type ADFHardBreakNode = z.infer<typeof ADFHardBreakNodeSchema>;

const ADFRuleNodeSchema = z.object({
  type: z.literal("rule"),
});

type ADFRuleNode = z.infer<typeof ADFRuleNodeSchema>;

// Base content node with recursive structure
const ADFContentNodeSchema: z.ZodType<any> = z.lazy(() =>
...
type ADFContentNode = z.infer<typeof ADFContentNodeSchema>;
...
const JiraUpdateIssueRequestSchema = z
  .record(
    z.union([
      z.string(),
      ADFDocumentSchema,
...
type JiraConnectionInfo = z.infer<typeof JiraConnectionInfoSchema>;
type JiraCreateIssueRequest = z.infer<
  typeof JiraCreateIssueRequestSchema
>;
type JiraUpdateIssueRequest = z.infer<
  typeof JiraUpdateIssueRequestSchema
>;
type JiraIssueLink = z.infer<typeof JiraIssueLinkSchema>;
type JiraIssueLinkType = z.infer<typeof JiraIssueLinkTypeSchema>;
type JiraCreateIssueLinkRequest = z.infer<
  typeof JiraCreateIssueLinkRequestSchema
>;
type JiraAttachment = z.infer<typeof JiraAttachmentSchema>;
type JiraAttachmentsResult = z.infer<typeof JiraAttachmentsResultSchema>;
type JiraIssueWithAttachments = z.infer<
