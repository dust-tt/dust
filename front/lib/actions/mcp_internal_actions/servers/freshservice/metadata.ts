...
export const getTicketReadFieldsSchema = {};
...
export const addTicketNoteSchema = {
  ticket_id: z.number().describe("The ID of the ticket"),
...
export const addTicketReplySchema = {
  ticket_id: z.number().describe("The ID of the ticket"),
  body: z.string().describe("Content of the note in HTML format"),
};

export const listTicketTasksSchema = {
  ticket_id: z.number().describe("The ID of the ticket"),
};

export const getTicketTaskSchema = {
  ticket_id: z.number().describe("The ID of the ticket"),
  task_id: z.number().describe("The ID of the task"),
};

export const createTicketTaskSchema = {
  ticket_id: z.number().describe("The ID of the ticket"),
  ...
  agent_id: z.number().optional().describe("Agent ID to assign the task to"),
  group_id: z.number().optional().describe("Group ID to assign the task to"),
};

export const updateTicketTaskSchema = {
  ticket_id: z.number().describe("The ID of the ticket"),
...
export const deleteTicketTaskSchema = {
  ticket_id: z.number().describe("The ID of the ticket"),
...
export const listOncallSchedulesSchema = {
  page: z.number().optional().default(1),
  per_page: z.number().optional().default(30),
};

export const listServiceCategoriesSchema = {
  page: z.number().optional().default(1),
  per_page: z.number().optional().default(30),
};

export const listServiceItemsSchema = {
  category_id: z
    .number()
    .optional()
    .describe(
...
export const searchServiceItemsSchema = {
  search_term: z
    .string()
    .describe(
...
export const getServiceItemSchema = {
  display_id: z.number().describe("The display ID of the service catalog item"),
};

export const getServiceItemFieldsSchema = {
  display_id: z.number().describe("The display ID of the service catalog item"),
};

export const requestServiceItemSchema = {
  display_id: z
    .number()
...
export const listSolutionCategoriesSchema = {
  page: z.number().optional().default(1),
  per_page: z.number().optional().default(30),
};

export const listSolutionFoldersSchema = {
  category_id: z.number().optional().describe("Filter by category ID"),
  page: z.number().optional().default(1),
  per_page: z.number().optional().default(30),
};

export const listSolutionArticlesSchema = {
  folder_id: z
    .number()
    .describe(
...
export const getSolutionArticleSchema = {
  article_id: z.number().describe("The ID of the solution article"),
};

export const createSolutionArticleSchema = {
...
export const listRequestersSchema = {
...
export const getRequesterSchema = {
...
export const listSlaPoliciesSchema = {};

export const getTicketWriteFieldsSchema = {
  search: z
    .string()
    .optional()
...
export const listCannedResponsesSchema = {
  search: z
    .string()
    .optional()
...
export const getCannedResponseSchema = {
  response_id: z.number().describe("The ID of the canned response"),
};

export const getTicketApprovalSchema = {
  ticket_id: z.number().describe("The ID of the ticket"),
  approval_id: z.number().describe("The ID of the approval to retrieve"),
};

export const listTicketApprovalsSchema = {
  ticket_id: z.number().describe("The ID of the ticket"),
};

export const requestServiceApprovalSchema = {
  ticket_id: z.number().describe("The ID of the ticket"),
  approver_id: z
    .number()
  ...
  approval_type: z
    .enum(["1", "2"])
    .describe("Approval type: 1=Everyone must approve, 2=Anyone can approve"),
  email_content: z
    .string()
    .optional()
    .describe(
...
export const FRESHSERVICE_TOOLS: MCPToolType[] = [
  {
    ...
    inputSchema: zodToJsonSchema(z.object(listTicketsSchema)) as JSONSchema,
  },
  {
    name: "get_ticket",
    description:
  ...
  },
  {
    ...
    inputSchema: zodToJsonSchema(
      z.object(getTicketReadFieldsSchema)
    ) as JSONSchema,
  },
  {
    name: "create_ticket",
    ...
    inputSchema: zodToJsonSchema(z.object(createTicketSchema)) as JSONSchema,
  },
  {
    name: "update_ticket",
    description: "Updates an existing ticket in Freshservice",
    inputSchema: zodToJsonSchema(z.object(updateTicketSchema)) as JSONSchema,
  },
  {
    name: "add_ticket_note",
    description: "Adds a note to an existing ticket",
    inputSchema: zodToJsonSchema(z.object(addTicketNoteSchema)) as JSONSchema,
  },
  {
    name: "add_ticket_reply",
    description: "Adds a reply to a ticket conversation",
    inputSchema: zodToJsonSchema(z.object(addTicketReplySchema)) as JSONSchema,
  },
  {
    name: "list_ticket_tasks",
    description: "Lists all tasks associated with a ticket",
    inputSchema: zodToJsonSchema(z.object(listTicketTasksSchema)) as JSONSchema,
  },
  {
    name: "get_ticket_task",
    description: "Gets detailed information about a specific task on a ticket",
    inputSchema: zodToJsonSchema(z.object(getTicketTaskSchema)) as JSONSchema,
  },
  {
    ...
    inputSchema: zodToJsonSchema(
      z.object(createTicketTaskSchema)
    ) as JSONSchema,
  },
  {
    ...
    inputSchema: zodToJsonSchema(
      z.object(updateTicketTaskSchema)
    ) as JSONSchema,
  },
  {
    ...
    inputSchema: zodToJsonSchema(
      z.object(deleteTicketTaskSchema)
    ) as JSONSchema,
  },
  {
    name: "list_departments",
    description: "Lists all departments in Freshservice",
    inputSchema: zodToJsonSchema(z.object(listDepartmentsSchema)) as JSONSchema,
  },
  {
    name: "list_products",
    description: "Lists all products in Freshservice",
    inputSchema: zodToJsonSchema(z.object(listProductsSchema)) as JSONSchema,
  },
  {
    name: "list_oncall_schedules",
    description: "Lists on-call schedules",
    inputSchema: zodToJsonSchema(
      z.object(listOncallSchedulesSchema)
    ) as JSONSchema,
  },
  {
    ...
    inputSchema: zodToJsonSchema(
      z.object(listServiceCategoriesSchema)
    ) as JSONSchema,
  },
  {
    ...
    inputSchema: zodToJsonSchema(
      z.object(listServiceItemsSchema)
    ) as JSONSchema,
  },
  {
    ...
    inputSchema: zodToJsonSchema(
      z.object(searchServiceItemsSchema)
    ) as JSONSchema,
  },
  {
    ...
    inputSchema: zodToJsonSchema(z.object(getServiceItemSchema)) as JSONSchema,
  },
  {
    ...
    inputSchema: zodToJsonSchema(
      z.object(getServiceItemFieldsSchema)
    ) as JSONSchema,
  },
  {
    ...
    inputSchema: zodToJsonSchema(
      z.object(requestServiceItemSchema)
    ) as JSONSchema,
  },
  {
    ...
    inputSchema: zodToJsonSchema(
      z.object(listSolutionCategoriesSchema)
    ) as JSONSchema,
  },
  {
    ...
    inputSchema: zodToJsonSchema(
      z.object(listSolutionFoldersSchema)
    ) as JSONSchema,
  },
  {
    ...
    inputSchema: zodToJsonSchema(
      z.object(listSolutionArticlesSchema)
    ) as JSONSchema,
  },
  {
    ...
    inputSchema: zodToJsonSchema(
      z.object(getSolutionArticleSchema)
    ) as JSONSchema,
  },
  {
    ...
    inputSchema: zodToJsonSchema(
      z.object(createSolutionArticleSchema)
    ) as JSONSchema,
  },
  {
    name: "list_requesters",
    description: "Lists requesters",
    inputSchema: zodToJsonSchema(z.object(listRequestersSchema)) as JSONSchema,
  },
  {
    name: "get_requester",
    description: "Gets detailed information about a specific requester",
    inputSchema: zodToJsonSchema(z.object(getRequesterSchema)) as JSONSchema,
  },
  {
    name: "list_purchase_orders",
    description: "Lists purchase orders",
    inputSchema: zodToJsonSchema(
      z.object(listPurchaseOrdersSchema)
    ) as JSONSchema,
  },
  {
    name: "list_sla_policies",
    description: "Lists SLA policies",
    inputSchema: zodToJsonSchema(z.object(listSlaPoliciesSchema)) as JSONSchema,
  },
  {
    ...
    inputSchema: zodToJsonSchema(
      z.object(getTicketWriteFieldsSchema)
    ) as JSONSchema,
  },
  {
    ...
    inputSchema: zodToJsonSchema(
      z.object(listCannedResponsesSchema)
    ) as JSONSchema,
  },
  {
    ...
    inputSchema: zodToJsonSchema(
      z.object(getCannedResponseSchema)
    ) as JSONSchema,
  },
  {
    ...
    inputSchema: zodToJsonSchema(
      z.object(getTicketApprovalSchema)
    ) as JSONSchema,
  },
  {
    ...
    inputSchema: zodToJsonSchema(
      z.object(listTicketApprovalsSchema)
    ) as JSONSchema,
  },
  {
    ...
    inputSchema: zodToJsonSchema(
      z.object(requestServiceApprovalSchema)
    ) as JSONSchema,
  },
];
