...
function createServer(
  ...
  const isJsonSchemaConfigured =
    agentLoopRunContext &&
    isServerSideMCPToolConfiguration(agentLoopRunContext.actionConfiguration) &&
    agentLoopRunContext.actionConfiguration.jsonSchema !== null;
  server.tool(
    "process_documents",
