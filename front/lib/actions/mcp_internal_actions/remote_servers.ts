...
export const DEFAULT_REMOTE_MCP_SERVERS: DefaultRemoteMCPServerConfig[] = [
  ...
  */
  ...
  },
  {
    ...
    connectionInstructions:
      "Qobra uses OAuth with dynamic client registration. You will be prompted to sign in with your Qobra account. Access is read-only and scoped to your Qobra role permissions. The Qobra MCP server is currently in beta and must be enabled per company by the Qobra team. If the sign-in screen says the feature isn't available for your account, email support@qobra.co to request activation for your workspace.",
    authMethod: "oauth-dynamic",
    supportedOAuthUseCases: ["personal_actions"],
    toolStakes: {
