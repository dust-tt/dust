...
export async function processToolResults(
  ...
  // FileResource-backed outputs (images, blobs, URL-fetched files) are conversation-scoped; tools
        ...
        case "image": {
          if (!conversation) {
            return {
              content: {
                type: "text",
                text: "Storing generated images is not supported outside of a conversation.",
              },
              file: null,
            };
          }
