...
const setup: StreamSetup = {
  createInstance: () =>
    new TogetheraiUsLlama3370BInstructTurboStream({
...
// NODE_ENV=test RUN_LLM_TEST=true npm run test -- --config lib/model_constructors/test/vite.config.js --bail 1 lib/model_constructors/test/endpoints/togetherai_us_llama_3_3_70b_instruct_turbo.test.ts
runStreamEndpointTests(TogetheraiUsLlama3370BInstructTurboStream, setup);
