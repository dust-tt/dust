...
const setup: StreamSetup = {
  createInstance: () =>
    new FireworksUsDeepSeekV4ProStream({
...
// NODE_ENV=test RUN_LLM_TEST=true npm run test -- --config lib/model_constructors/test/vite.config.js --bail 1 lib/model_constructors/test/endpoints/fireworks_us_deepseek_v4_pro.test.ts
runStreamEndpointTests(FireworksUsDeepSeekV4ProStream, setup);
