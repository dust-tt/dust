...
export const OpenAIGptFiveDotFiveEuropeOpenAIResponsesStreamSetup: StreamSetup =
  {
    createInstance: () =>
      new OpenAIGptFiveDotFiveEuropeOpenAIResponsesStream({
...
// NODE_ENV=test RUN_LLM_TEST=true npm run test -- --config lib/model_constructors/test/vite.config.js --bail 1 lib/model_constructors/test/endpoints/openai_gpt_five_dot_five_eu_openai_responses.test.ts
