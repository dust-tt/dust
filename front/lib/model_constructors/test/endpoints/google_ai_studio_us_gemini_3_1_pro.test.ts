...
const setup: StreamSetup = {
  createInstance: () =>
    new GoogleAiStudioUsGeminiThreeDotOneProStream({
...
// NODE_ENV=test RUN_LLM_TEST=true npm run test -- --config lib/model_constructors/test/vite.config.js --bail 1 lib/model_constructors/test/endpoints/google_ai_studio_us_gemini_3_1_pro.test.ts
runStreamEndpointTests(GoogleAiStudioUsGeminiThreeDotOneProStream, setup);
