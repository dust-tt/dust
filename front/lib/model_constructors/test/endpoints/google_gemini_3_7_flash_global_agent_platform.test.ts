...
export const GoogleGeminiThreeDotSevenFlashGlobalAgentPlatformStreamSetup: StreamSetup =
  {
    createInstance: () =>
...
// NODE_ENV=test RUN_LLM_TEST=true npm run test -- --config lib/model_constructors/test/vite.config.js --bail 1 lib/model_constructors/test/endpoints/google_gemini_3_7_flash_global_agent_platform.test.ts
