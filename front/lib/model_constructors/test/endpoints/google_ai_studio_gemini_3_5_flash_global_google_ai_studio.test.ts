...
export const GoogleAiStudioGeminiThreeDotFiveFlashGlobalGoogleAiStudioStreamSetup: StreamSetup =
  {
    createInstance: () =>
      new GoogleAiStudioGeminiThreeDotFiveFlashGlobalGoogleAiStudioStream({
...
// NODE_ENV=test RUN_LLM_TEST=true npm run test -- --config lib/model_constructors/test/vite.config.js --bail 1 lib/model_constructors/test/endpoints/google_ai_studio_gemini_3_5_flash_global_google_ai_studio.test.ts
