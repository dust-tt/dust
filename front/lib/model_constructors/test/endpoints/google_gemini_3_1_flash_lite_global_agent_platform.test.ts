...
export const GoogleAiStudioGeminiThreeDotOneFlashLiteGlobalAgentPlatformStreamSetup: StreamSetup =
  {
    createInstance: () =>
      new GoogleAiStudioGeminiThreeDotOneFlashLiteGlobalAgentPlatformStream({
