...
export const AnthropicClaudeSonnetFiveGlobalAnthropicStreamSetup: StreamSetup =
  {
    createInstance: () =>
      new AnthropicClaudeSonnetFiveGlobalAnthropicStream({
    ...
    tests: {
      ...
      // Temperature is not supported by the model.
...
// NODE_ENV=test RUN_LLM_TEST=true npm run test -- --config lib/model_constructors/test/vite.config.js --bail 1 lib/model_constructors/test/endpoints/anthropic_claude_sonnet_five_global_anthropic.test.ts
