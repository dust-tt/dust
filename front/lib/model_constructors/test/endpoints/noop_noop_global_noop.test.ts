...
export const NoopNoopGlobalNoopStreamSetup: StreamSetup = {
  createInstance: () => new NoopNoopGlobalNoopStream({}),
  tests: {
...
// NODE_ENV=test RUN_LLM_TEST=true npm run test -- --config lib/model_constructors/test/vite.config.js --bail 1 lib/model_constructors/test/endpoints/noop_noop_global_noop.test.ts
runStreamEndpointTests(NoopNoopGlobalNoopStream, NoopNoopGlobalNoopStreamSetup);
