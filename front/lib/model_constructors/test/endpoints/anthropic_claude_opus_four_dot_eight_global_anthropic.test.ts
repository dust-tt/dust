...
export const AnthropicClaudeOpusFourDotEightGlobalAnthropicStreamSetup: StreamSetup =
  {
    createInstance: () =>
      new AnthropicClaudeOpusFourDotEightGlobalAnthropicStream({
...
// NODE_ENV=test RUN_LLM_TEST=true npm run test -- --config lib/model_constructors/test/vite.config.js --bail 1 lib/model_constructors/test/endpoints/anthropic_claude_opus_four_dot_eight_global_anthropic.test.ts
