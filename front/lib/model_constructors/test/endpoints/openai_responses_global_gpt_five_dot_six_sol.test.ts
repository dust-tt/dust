...
export const OpenAIResponsesGlobalGptFiveDotSixSolStreamSetup: StreamSetup = {
  createInstance: () =>
    new OpenAIResponsesGlobalGptFiveDotSixSolStream({
...
// NODE_ENV=test RUN_LLM_TEST=true npm run test -- --config lib/model_constructors/test/vite.config.js --bail 1 lib/model_constructors/test/endpoints/openai_responses_global_gpt_five_dot_six_sol.test.ts
