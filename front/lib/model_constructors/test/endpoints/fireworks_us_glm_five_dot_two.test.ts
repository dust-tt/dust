...
const setup: StreamSetup = {
  createInstance: () =>
    new FireworksUsGlmFiveDotTwoStream({
...
// NODE_ENV=test RUN_LLM_TEST=true npm run test -- --config lib/model_constructors/test/vite.config.js --bail 1 lib/model_constructors/test/endpoints/fireworks_us_glm_five_dot_two.test.ts
runStreamEndpointTests(FireworksUsGlmFiveDotTwoStream, setup);
