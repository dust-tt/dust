...
const setup: StreamSetup = {
  createInstance: () =>
    new FireworksUsKimiK2Dot5Stream({
...
// NODE_ENV=test RUN_LLM_TEST=true npm run test -- --config lib/model_constructors/test/vite.config.js --bail 1 lib/model_constructors/test/endpoints/fireworks_us_kimi_k2_dot_five.test.ts
runStreamEndpointTests(FireworksUsKimiK2Dot5Stream, setup);
