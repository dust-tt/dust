...
export const MistralMistralLargeEuropeMistralStreamSetup: StreamSetup = {
  createInstance: () =>
    new MistralMistralLargeEuropeMistralStream({
...
// NODE_ENV=test RUN_LLM_TEST=true npm run test -- --config lib/model_constructors/test/vite.config.js --bail 1 lib/model_constructors/test/endpoints/mistral_mistral_large_eu_mistral.test.ts
