...
export const AnthropicClaudeHaikuFourDotFiveGlobalAnthropicStreamSetup: StreamSetup =
  {
    createInstance: () =>
      new AnthropicClaudeHaikuFourDotFiveGlobalAnthropicStream({
...
// NODE_ENV=test RUN_LLM_TEST=true npm run test -- --config lib/model_constructors/test/vite.config.js --bail 1 lib/model_constructors/test/endpoints/anthropic_claude_haiku_four_dot_five_global_anthropic.test.ts
