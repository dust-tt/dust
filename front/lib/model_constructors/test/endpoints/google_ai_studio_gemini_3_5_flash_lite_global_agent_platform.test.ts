...
export const GoogleAiStudioGeminiThreeDotFiveFlashLiteGlobalAgentPlatformStreamSetup: StreamSetup =
  {
    createInstance: () =>
      new GoogleAiStudioGeminiThreeDotFiveFlashLiteGlobalAgentPlatformStream({
...
// NODE_ENV=test RUN_LLM_TEST=true npm run test -- --config lib/model_constructors/test/vite.config.js --bail 1 lib/model_constructors/test/endpoints/google_ai_studio_gemini_3_5_flash_lite_global_agent_platform.test.ts
