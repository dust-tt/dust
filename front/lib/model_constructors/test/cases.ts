...
// =============================================================================
// Shared, endpoint-agnostic test definitions.
//
// This file is COMMON to every stream endpoint: it declares the conversations,
// tool specs, the matrix of test cases (`TEST_CASES`), and the response checkers
// each case asserts by default. Per-endpoint files (see `test/endpoints/*`)
// narrow these — toggling which cases run and overriding expected outputs (e.g.
// a case that should error on one model but succeed on another).
// =============================================================================
