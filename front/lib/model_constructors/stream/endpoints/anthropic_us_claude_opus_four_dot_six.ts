...
export class AnthropicUsClaudeOpusFourDotSixStream extends WithAnthropicClaudeOpusFourDotSixConfig(
  AnthropicStream
) {
...
AnthropicUsClaudeOpusFourDotSixStream satisfies StreamEndpointConstructor<
  MessageCreateParamsNonStreaming,
  RawMessageStreamEvent,
