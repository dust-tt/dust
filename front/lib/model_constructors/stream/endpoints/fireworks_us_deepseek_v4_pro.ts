...
export class FireworksUsDeepSeekV4ProStream extends WithFireworksDeepSeekV4ProConfig(
  FireworksStream
) {
...
FireworksUsDeepSeekV4ProStream satisfies StreamEndpointConstructor;
