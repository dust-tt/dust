...
export class OpenAIGptFiveDotSixTerraEuropeOpenAIResponsesStream extends WithOpenAIGptFiveDotSixTerraConfig(
...
OpenAIGptFiveDotSixTerraEuropeOpenAIResponsesStream satisfies StreamEndpointConstructor;
