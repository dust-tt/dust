...
export class OpenAIGptFiveMiniEuropeOpenAIResponsesStream extends WithOpenAIGptFiveMiniConfig(
...
OpenAIGptFiveMiniEuropeOpenAIResponsesStream satisfies StreamEndpointConstructor;
