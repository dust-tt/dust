...
import type { ClaudeSonnetFourDotSix } from "@app/lib/model_constructors/providers/anthropic/models/claude_sonnet_four_dot_six";
...
export class AnthropicClaudeSonnetFourDotSixGlobalAnthropicStream extends WithAnthropicClaudeSonnetFourDotSixConfig(
  AnthropicStream
) {
...
AnthropicClaudeSonnetFourDotSixGlobalAnthropicStream satisfies StreamEndpointConstructor<
