...
export class OpenAIGptFiveDotFourEuropeOpenAIResponsesStream extends WithOpenAIGptFiveDotFourConfig(
...
OpenAIGptFiveDotFourEuropeOpenAIResponsesStream satisfies StreamEndpointConstructor;
