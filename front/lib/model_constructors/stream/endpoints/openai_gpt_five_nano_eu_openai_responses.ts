...
export class OpenAIGptFiveNanoEuropeOpenAIResponsesStream extends WithOpenAIGptFiveNanoConfig(
...
OpenAIGptFiveNanoEuropeOpenAIResponsesStream satisfies StreamEndpointConstructor;
