...
export class OpenAIResponsesGlobalGptFiveDotSixSolStream extends WithOpenAIGptFiveDotSixSolConfig(
...
OpenAIResponsesGlobalGptFiveDotSixSolStream satisfies StreamEndpointConstructor;
