...
export class OpenAIGptFiveDotOneEuropeOpenAIResponsesStream extends WithOpenAIGptFiveDotOneConfig(
...
OpenAIGptFiveDotOneEuropeOpenAIResponsesStream satisfies StreamEndpointConstructor;
