...
export class AnthropicUsClaudeOpusFourDotSevenStream extends WithAnthropicClaudeOpusFourDotSevenConfig(
  AnthropicStream
) {
...
AnthropicUsClaudeOpusFourDotSevenStream satisfies StreamEndpointConstructor<
  MessageCreateParamsNonStreaming,
  RawMessageStreamEvent,
