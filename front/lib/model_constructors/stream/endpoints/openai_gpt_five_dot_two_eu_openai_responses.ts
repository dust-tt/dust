...
export class OpenAIGptFiveDotTwoEuropeOpenAIResponsesStream extends WithOpenAIGptFiveDotTwoConfig(
...
OpenAIGptFiveDotTwoEuropeOpenAIResponsesStream satisfies StreamEndpointConstructor;
