...
export class OpenAIGptFiveEuropeOpenAIResponsesStream extends WithOpenAIGptFiveConfig(
...
OpenAIGptFiveEuropeOpenAIResponsesStream satisfies StreamEndpointConstructor;
