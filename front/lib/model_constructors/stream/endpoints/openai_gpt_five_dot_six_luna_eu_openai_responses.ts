...
export class OpenAIGptFiveDotSixLunaEuropeOpenAIResponsesStream extends WithOpenAIGptFiveDotSixLunaConfig(
...
OpenAIGptFiveDotSixLunaEuropeOpenAIResponsesStream satisfies StreamEndpointConstructor;
