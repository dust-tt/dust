...
export class AnthropicClaudeOpusFourDotSixEuropeAgentPlatformStream extends WithAnthropicClaudeOpusFourDotSixConfig(
...
AnthropicClaudeOpusFourDotSixEuropeAgentPlatformStream satisfies StreamEndpointConstructor;
