...
export class AnthropicClaudeOpusFourDotEightGlobalAnthropicStream extends WithAnthropicClaudeOpusFourDotEightConfig(
  AnthropicStream
) {
...
AnthropicClaudeOpusFourDotEightGlobalAnthropicStream satisfies StreamEndpointConstructor<
