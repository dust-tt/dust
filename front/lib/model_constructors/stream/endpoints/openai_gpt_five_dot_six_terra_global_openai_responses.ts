...
export class OpenAIGptFiveDotSixTerraGlobalOpenAIResponsesStream extends WithOpenAIGptFiveDotSixTerraConfig(
...
OpenAIGptFiveDotSixTerraGlobalOpenAIResponsesStream satisfies StreamEndpointConstructor;
