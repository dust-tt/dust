...
export class AnthropicClaudeOpusFourDotSixGlobalAnthropicStream extends WithAnthropicClaudeOpusFourDotSixConfig(
  AnthropicStream
) {
...
AnthropicClaudeOpusFourDotSixGlobalAnthropicStream satisfies StreamEndpointConstructor<
