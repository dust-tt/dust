...
export class AnthropicClaudeHaikuFourDotFiveEuropeAgentPlatformStream extends WithAnthropicClaudeHaikuFourDotFiveConfig(
...
AnthropicClaudeHaikuFourDotFiveEuropeAgentPlatformStream satisfies StreamEndpointConstructor;
