...
export class TogetheraiUsLlama3370BInstructTurboStream extends WithTogetheraiLlama3370BInstructTurboConfig(
  TogetheraiStream
) {
...
TogetheraiUsLlama3370BInstructTurboStream satisfies StreamEndpointConstructor;
