...
export class AnthropicClaudeFableFiveGlobalAnthropicStream extends WithAnthropicClaudeFableFiveConfig(
  AnthropicStream
) {
...
AnthropicClaudeFableFiveGlobalAnthropicStream satisfies StreamEndpointConstructor<
