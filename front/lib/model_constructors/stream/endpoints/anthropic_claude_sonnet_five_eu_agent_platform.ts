...
export class AnthropicClaudeSonnetFiveEuropeAgentPlatformStream extends WithAnthropicClaudeSonnetFiveConfig(
...
AnthropicClaudeSonnetFiveEuropeAgentPlatformStream satisfies StreamEndpointConstructor;
