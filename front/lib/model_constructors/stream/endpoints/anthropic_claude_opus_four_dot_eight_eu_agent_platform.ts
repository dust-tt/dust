...
export class AnthropicClaudeOpusFourDotEightEuropeAgentPlatformStream extends WithAnthropicClaudeOpusFourDotEightConfig(
...
AnthropicClaudeOpusFourDotEightEuropeAgentPlatformStream satisfies StreamEndpointConstructor;
