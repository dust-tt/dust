...
export class OpenAIGptFiveDotFourMiniEuropeOpenAIResponsesStream extends WithOpenAIGptFiveDotFourMiniConfig(
...
OpenAIGptFiveDotFourMiniEuropeOpenAIResponsesStream satisfies StreamEndpointConstructor;
