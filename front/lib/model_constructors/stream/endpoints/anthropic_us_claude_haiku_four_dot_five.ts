...
export class AnthropicUsClaudeHaikuFourDotFiveStream extends WithAnthropicClaudeHaikuFourDotFiveConfig(
  AnthropicStream
) {
...
AnthropicUsClaudeHaikuFourDotFiveStream satisfies StreamEndpointConstructor<
  MessageCreateParamsNonStreaming,
  RawMessageStreamEvent,
