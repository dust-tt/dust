...
export class OpenAIGptFiveDotFiveEuropeOpenAIResponsesStream extends WithOpenAIGptFiveDotFiveConfig(
...
OpenAIGptFiveDotFiveEuropeOpenAIResponsesStream satisfies StreamEndpointConstructor;
