...
export class AnthropicUsClaudeOpusFourDotEightStream extends WithAnthropicClaudeOpusFourDotEightConfig(
  AnthropicStream
) {
...
AnthropicUsClaudeOpusFourDotEightStream satisfies StreamEndpointConstructor<
  MessageCreateParamsNonStreaming,
  RawMessageStreamEvent,
