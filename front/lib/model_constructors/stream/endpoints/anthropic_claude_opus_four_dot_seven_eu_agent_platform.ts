...
export class AnthropicClaudeOpusFourDotSevenEuropeAgentPlatformStream extends WithAnthropicClaudeOpusFourDotSevenConfig(
...
AnthropicClaudeOpusFourDotSevenEuropeAgentPlatformStream satisfies StreamEndpointConstructor;
