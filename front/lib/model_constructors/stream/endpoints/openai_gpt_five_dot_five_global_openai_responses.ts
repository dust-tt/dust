...
export class OpenAIGptFiveDotFiveGlobalOpenAIResponsesStream extends WithOpenAIGptFiveDotFiveConfig(
...
OpenAIGptFiveDotFiveGlobalOpenAIResponsesStream satisfies StreamEndpointConstructor;
