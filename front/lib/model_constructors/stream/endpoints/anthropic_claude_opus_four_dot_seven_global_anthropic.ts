...
export class AnthropicClaudeOpusFourDotSevenGlobalAnthropicStream extends WithAnthropicClaudeOpusFourDotSevenConfig(
  AnthropicStream
) {
...
AnthropicClaudeOpusFourDotSevenGlobalAnthropicStream satisfies StreamEndpointConstructor<
