...
import { GPT_5_2_MODEL_ID } from "@app/lib/model_constructors/types/model_ids";
...
// gpt-5.2 accepts none/low/medium/high/xhigh. "minimal" and the universal
...
const configSchema = z.union([
  inputConfigSchema.extend({
    reasoning: z
      .object({ effort: z.enum(GPT_5_2_REASONING_EFFORTS) })
...
>(Base: TBase) {
  abstract class OpenAIGptFiveDotTwo extends Base {
    static readonly modelId = GPT_5_2_MODEL_ID;
