...
export class GoogleAiStudioUsGeminiThreeDotFiveFlashBatch extends WithGoogleAiStudioGeminiThreeDotFiveFlashConfig(
  GoogleAiStudioBatch
) {
...
GoogleAiStudioUsGeminiThreeDotFiveFlashBatch satisfies BatchEndpointConstructor;
