...
export class AnthropicUsClaudeSonnetFourDotSixBatch extends WithAnthropicClaudeSonnetFourDotSixConfig(
  AnthropicBatch
) {
...
AnthropicUsClaudeSonnetFourDotSixBatch satisfies BatchEndpointConstructor;
