...
export class GoogleAiStudioUsGeminiThreeDotOneFlashLiteBatch extends WithGoogleAiStudioGeminiThreeDotOneFlashLiteConfig(
  GoogleAiStudioBatch
) {
...
GoogleAiStudioUsGeminiThreeDotOneFlashLiteBatch satisfies BatchEndpointConstructor;
