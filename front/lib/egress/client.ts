 ...
 * `resolveRequest` MUST be the only place resolving a client request's URL and auth context: a
 * transport MUST NOT re-derive any of it, nor send credentials or headers it did not return.
 */
