...
// encoding overhead for escaping. The body-parser `config` in the documents endpoint must
// stay in sync with this value (a string literal is required there for static analysis).
