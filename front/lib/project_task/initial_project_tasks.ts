...
const NEXT_TODO_PROMPT =
  "After the user agrees to mark this todo done, check what other todos are still open in the project. Propose tackling the most relevant next open one to the user. If they agree, use start_task_agent to kick off a conversation for it and share the conversation link in your reply.";
