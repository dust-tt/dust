...
export class DustMistralMistralMedium35EuropeMistralStream extends WithDustMistralMedium35Config(
  MistralMistralMedium35EuropeMistralStream
) {
  static readonly endpointFilter = {};
}

defineDustStreamEndpoint(DustMistralMistralMedium35EuropeMistralStream);
