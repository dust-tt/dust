...
export class DustOpenAIGptFiveDotTwoGlobalOpenAIResponsesStream extends WithDustGptFiveDotTwoConfig(
  OpenAIGptFiveDotTwoGlobalOpenAIResponsesStream
) {
  static readonly endpointFilter = {};
}

defineDustStreamEndpoint(DustOpenAIGptFiveDotTwoGlobalOpenAIResponsesStream);
