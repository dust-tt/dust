...
export class DustFireworksGlmFiveDotTwoGlobalFireworksStream extends WithDustFireworksGlm52Config(
  FireworksGlmFiveDotTwoGlobalFireworksStream
) {
  static readonly endpointFilter = {};
}

defineDustStreamEndpoint(DustFireworksGlmFiveDotTwoGlobalFireworksStream);
