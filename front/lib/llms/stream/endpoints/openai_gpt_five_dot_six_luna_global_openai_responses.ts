...
export class DustOpenAIGptFiveDotSixLunaGlobalOpenAIResponsesStream extends WithDustGptFiveDotSixLunaConfig(
  OpenAIGptFiveDotSixLunaGlobalOpenAIResponsesStream
) {
  static readonly endpointFilter = {};
}

defineDustStreamEndpoint(DustOpenAIGptFiveDotSixLunaGlobalOpenAIResponsesStream);
