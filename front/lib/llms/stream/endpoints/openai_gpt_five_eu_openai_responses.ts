...
export class DustOpenAIGptFiveEuropeOpenAIResponsesStream extends WithDustGptFiveConfig(
  OpenAIGptFiveEuropeOpenAIResponsesStream
) {
  static readonly endpointFilter = {};
}

defineDustStreamEndpoint(DustOpenAIGptFiveEuropeOpenAIResponsesStream);
