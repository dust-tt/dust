...
export class DustOpenAIGptFiveGlobalOpenAIResponsesStream extends WithDustGptFiveConfig(
  OpenAIGptFiveGlobalOpenAIResponsesStream
) {
  static readonly endpointFilter = {};
}

defineDustStreamEndpoint(DustOpenAIGptFiveGlobalOpenAIResponsesStream);
