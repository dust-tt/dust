...
export class DustMistralMistralSmallEuropeMistralStream extends WithDustMistralSmallConfig(
  MistralMistralSmallEuropeMistralStream
) {
  static readonly endpointFilter = {};
}

defineDustStreamEndpoint(DustMistralMistralSmallEuropeMistralStream);
