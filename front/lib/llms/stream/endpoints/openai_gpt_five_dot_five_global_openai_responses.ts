...
export class DustOpenAIGptFiveDotFiveGlobalOpenAIResponsesStream extends WithDustGptFiveDotFiveConfig(
  OpenAIGptFiveDotFiveGlobalOpenAIResponsesStream
) {
  static readonly endpointFilter = {};
}

defineDustStreamEndpoint(DustOpenAIGptFiveDotFiveGlobalOpenAIResponsesStream);
