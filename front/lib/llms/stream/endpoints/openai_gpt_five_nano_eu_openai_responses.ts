...
export class DustOpenAIGptFiveNanoEuropeOpenAIResponsesStream extends WithDustGptFiveNanoConfig(
  OpenAIGptFiveNanoEuropeOpenAIResponsesStream
) {
  static readonly endpointFilter = {};
}

defineDustStreamEndpoint(DustOpenAIGptFiveNanoEuropeOpenAIResponsesStream);
