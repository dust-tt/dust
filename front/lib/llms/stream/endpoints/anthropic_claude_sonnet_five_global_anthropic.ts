...
export class DustAnthropicClaudeSonnetFiveGlobalAnthropicStream extends WithDustClaudeSonnetFiveConfig(
  AnthropicClaudeSonnetFiveGlobalAnthropicStream
) {
  static readonly endpointFilter = {};
}

defineDustStreamEndpoint(DustAnthropicClaudeSonnetFiveGlobalAnthropicStream);
