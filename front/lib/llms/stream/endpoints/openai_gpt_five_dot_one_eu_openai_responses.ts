...
export class DustOpenAIGptFiveDotOneEuropeOpenAIResponsesStream extends WithDustGptFiveDotOneConfig(
  OpenAIGptFiveDotOneEuropeOpenAIResponsesStream
) {
  static readonly endpointFilter = {};
}

defineDustStreamEndpoint(DustOpenAIGptFiveDotOneEuropeOpenAIResponsesStream);
