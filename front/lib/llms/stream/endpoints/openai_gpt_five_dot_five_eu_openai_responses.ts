...
export class DustOpenAIGptFiveDotFiveEuropeOpenAIResponsesStream extends WithDustGptFiveDotFiveConfig(
  OpenAIGptFiveDotFiveEuropeOpenAIResponsesStream
) {
  static readonly endpointFilter = {};
}

defineDustStreamEndpoint(DustOpenAIGptFiveDotFiveEuropeOpenAIResponsesStream);
