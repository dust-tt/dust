...
export class DustAnthropicClaudeSonnetFourDotSixGlobalAnthropicStream extends WithDustClaudeSonnetFourDotSixConfig(
  AnthropicClaudeSonnetFourDotSixGlobalAnthropicStream
) {
  static readonly endpointFilter = {};
}

defineDustStreamEndpoint(DustAnthropicClaudeSonnetFourDotSixGlobalAnthropicStream);
