...
export class DustMistralMistralMedium35GlobalMistralBatch extends MistralMistralMedium35GlobalMistralBatch {
  static readonly endpointFilter = {};
  static readonly modelConfig = MISTRAL_MEDIUM_3_5_MODEL_CONFIG;
}

defineDustBatchEndpoint(DustMistralMistralMedium35GlobalMistralBatch);
