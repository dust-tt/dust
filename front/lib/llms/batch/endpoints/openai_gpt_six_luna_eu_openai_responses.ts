...
export class DustOpenAIGptSixLunaEuropeOpenAIResponsesBatch extends OpenAIGptSixLunaEuropeOpenAIResponsesBatch {
  static readonly endpointFilter = {};
  static readonly modelConfig = GPT_6_LUNA_MODEL_CONFIG;
}

defineDustBatchEndpoint(DustOpenAIGptSixLunaEuropeOpenAIResponsesBatch);
