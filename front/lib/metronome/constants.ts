...
const DEV_METRIC_LLM_COST_AWU_PROGRAMMATIC =
  "ab8c7c1d-2bf1-481b-929d-0169d2467312";
const DEV_METRIC_LLM_COST_AWU_USER = "71487ad7-4904-4f40-81a7-88f62f28d4d7";

// Products
const DEV_PRODUCT_PROGRAMMATIC_USAGE = "daaf92ec-d0a7-444d-972e-a2d48c7edd0c";
const DEV_PRODUCT_AI_USAGE_USER = "de8d80ec-4827-42cf-8f02-07a0a9e9a8ec";
const DEV_PRODUCT_AI_USAGE_PROGRAMMATIC =
  "44c0b549-854f-4a7d-adfc-c4dd6aeb7c2b";
...
const PROD_METRIC_LLM_COST_AWU_PROGRAMMATIC =
  "0ec59e23-d06f-4598-a318-7a3c055a1214";
const PROD_METRIC_LLM_COST_AWU_USER = "c5c0b148-77ef-48f8-b862-aef149a3a3d3";

// Products
const PROD_PRODUCT_PROGRAMMATIC_USAGE = "cb21a6da-9790-4ab4-bb2d-0a82d5fdf4f3";
const PROD_PRODUCT_AI_USAGE_USER = "f225e5a6-113e-4e3e-8436-bb2e315e8982";
const PROD_PRODUCT_AI_USAGE_PROGRAMMATIC =
  "c1f8c754-896f-449a-8391-a4e651818c13";
...
export const getMetricLlmCostAwuProgrammaticId = () =>
  devOrProd(
    DEV_METRIC_LLM_COST_AWU_PROGRAMMATIC,
    PROD_METRIC_LLM_COST_AWU_PROGRAMMATIC
  );
export const getMetricLlmCostAwuUserId = () =>
  devOrProd(DEV_METRIC_LLM_COST_AWU_USER, PROD_METRIC_LLM_COST_AWU_USER);
