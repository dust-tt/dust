...
export const visualizationWithFileManagerSystemPrompt = () => `\
## CREATING VISUALIZATIONS WITH FILE MANAGER

You have access to a file manager that allows you to create and update executable files. When creating visualizations, you should create files instead of using the :::visualization directive.
