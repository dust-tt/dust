 ...
 * This selector permits grant-backed agent reads only when `agent_permission_grants` is enabled
 * and `use_legacy_acls` is off; grant read failures must propagate without legacy fallback.
 */
