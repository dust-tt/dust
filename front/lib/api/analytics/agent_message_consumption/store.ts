...
/**
 * @cc [owner:id13,label:architecture;data-integrity] incremental-consumption-shadow-isolation
 * Incremental consumption snapshots MUST write to the shadow alias and MUST NOT modify the
 * production consumption analytics index.
 */
export async function upsertVersionedShadowAgentMessageConsumptionAnalyticsDocuments(
  documents: {
