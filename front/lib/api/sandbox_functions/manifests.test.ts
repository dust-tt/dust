...
} from "../../../../cli/dust-sandbox/functions-runner/types/db";

// The shape is compile-time checked against the runner's types/db.ts (see
// manifests.ts); runtime constants can't be, so their mirrored values are asserted here.
describe("function state mirror", () => {
  ...
  it("parses a valid function state", () => {
    const result = functionStateSchema.safeParse({
      version: 1,
      databases: {
        chat: {
