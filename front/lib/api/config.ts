import { DEFAULT_CREDIT_SPEND_CHECKPOINT_THRESHOLD_AWU_CREDITS } from "@app/lib/constants/credits";
...
const config = {
  ...
  getCreditSpendCheckpointThresholdAwuCredits: (): number => {
    ...
    if (!value) {
      return DEFAULT_CREDIT_SPEND_CHECKPOINT_THRESHOLD_AWU_CREDITS;
    }
