...
export const notion = createPlugin({
  manifest: {
    id: "notion-unstuck-synching-nodes",
    name: "Unstuck synching nodes",
    description:
      "If the synching nodes are stuck, you can use this plugin to unstuck them: it works by clearing the parentsLastUpdatedAt field, so that all parents are synced at the end of the next sync",
