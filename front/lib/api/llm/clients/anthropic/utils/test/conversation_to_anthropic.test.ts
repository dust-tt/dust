...
describe("detectAnthropicToolSearchEnableSkillConflict", () => {
  const enableSkillAndSearch = {
    role: "assistant",
    function_calls: [
      {
        id: "toolu_test_enable",
  ...
  } satisfies ModelMessageTypeMultiActionsWithoutContentFragment;

  const enableSkillResult = {
    role: "function",
    name: "skill_management__enable_skill",
    function_call_id: "toolu_test_enable",
    content: "Skill enabled.",
  } satisfies ModelMessageTypeMultiActionsWithoutContentFragment;

  const enabledSkillInstructions = {
    role: "user",
    name: "system",
    content: [{ type: "text", text: "<dust_system>Skill</dust_system>" }],
  } satisfies ModelMessageTypeMultiActionsWithoutContentFragment;
    ...
    contents: [
      {
        ...
        value: {
          ...
          block: {
            type: "tool_search_tool_result",
            tool_use_id: "srvtoolu_test_search",
            content: {
              type: "tool_search_tool_search_result",
              tool_references: [],
            },
  ...
  it("detects the suspected enable_skill plus pending tool-search replay", () => {
    expect(
      detectAnthropicToolSearchEnableSkillConflict([
        enableSkillAndSearch,
        enableSkillResult,
