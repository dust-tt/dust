...
import type { CONFLUENCE_TOOLS_METADATA } from "@app/lib/api/actions/servers/confluence/metadata";
import {
...
export const CONFLUENCE_TOOL_HANDLERS: ToolHandlers<
  typeof CONFLUENCE_TOOLS_METADATA
> = {
