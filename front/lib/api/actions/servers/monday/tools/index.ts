...
import type { MONDAY_TOOLS_METADATA } from "@app/lib/api/actions/servers/monday/metadata";
import { Err, Ok } from "@app/types/shared/result";

export const MONDAY_TOOL_HANDLERS: ToolHandlers<typeof MONDAY_TOOLS_METADATA> =
  {
