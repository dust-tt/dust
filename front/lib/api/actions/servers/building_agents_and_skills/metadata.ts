...
export const BUILDING_AGENTS_AND_SKILLS_TOOLS_METADATA = [
  ...
  },
  {
    ...
    description:
      ...
      "can review, accept, or reject. Refused when a skill with the same name exists, or when " +
      "similar skills exist unless bypassSimilarSkillCheck is set after the user confirmed.",
