...
import type { AGENT_SIDEKICK_AGENT_STATE_TOOLS_METADATA } from "@app/lib/api/actions/servers/agent_sidekick_agent_state/metadata";
import {
...
export const AGENT_SIDEKICK_AGENT_STATE_TOOL_HANDLERS: ToolHandlers<
  typeof AGENT_SIDEKICK_AGENT_STATE_TOOLS_METADATA
> = {
