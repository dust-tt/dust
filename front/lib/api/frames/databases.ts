...
/**
 * Run one SQL statement (SELECT or DML) against a Frame database. An oversized result comes back
 * as a preview plus a `resultsFile` path on the Frame sandbox that the caller cannot read; #32457
