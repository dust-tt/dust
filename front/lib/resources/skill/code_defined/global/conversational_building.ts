...
- \`${BUILDING_AGENTS_AND_SKILLS_SERVER_NAME}.suggest_skill_creation\`: propose a new skill as a draft for users allowed to create skills to review. Refused when a skill with the same name or a similar one already exists, unless the user explicitly wants a separate skill.
