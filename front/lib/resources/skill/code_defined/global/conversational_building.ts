...
- \`${BUILDING_AGENTS_AND_SKILLS_SERVER_NAME}.suggest_skill_deletion\`: propose deleting an existing custom skill by \`skillId\`, with an \`analysis\` explaining why. Nothing is deleted for real: the proposal is recorded as a suggestion that the skill's editors review, accept, or reject.
