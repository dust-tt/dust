import type { LightWorkspaceType, Result, SubscriptionType } from "@dust-tt/types";
...
export class SubscriptionResource extends BaseResource<Subscription> {
  ...
  static async fetchByWorkspace(workspace: LightWorkspaceType): Promise<SubscriptionType> {
