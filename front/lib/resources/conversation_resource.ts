...
export class ConversationResource extends BaseResource<ConversationModel> {
   ...
   * message's checkpoint status and whether its triggering user message is a root message (one
   * not itself generated by another agent, i.e. with no `agenticMessageType`). Returns null when
   * either message cannot be found.
   */
