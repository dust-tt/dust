...
// ProjectTaskVersionModel can extend ProjectTaskModel without duplicating
...
// foreign key in ProjectTaskVersionModel and all join tables.

export class ProjectTaskModel extends WorkspaceAwareModel<ProjectTaskModel> {
...
export class ProjectTaskVersionModel extends ProjectTaskModel {
  declare projectTodoId: ForeignKey<ProjectTaskModel["id"]>;
  declare version: number;
}

ProjectTaskVersionModel.init(
  {
    ...PROJECT_TODO_MODEL_ATTRIBUTES,
    projectTodoId: {
      type: DataTypes.BIGINT,
...
ProjectTaskVersionModel.belongsTo(ProjectTaskModel, {
  foreignKey: { name: "projectTodoId", allowNull: false },
  onDelete: "RESTRICT",
  as: "projectTodo",
});

ProjectTaskModel.hasMany(ProjectTaskVersionModel, {
  foreignKey: { name: "projectTodoId", allowNull: false },
  as: "versions",
});

ProjectTaskModel.belongsTo(SpaceModel, {
  foreignKey: { name: "spaceId", allowNull: false },
  onDelete: "RESTRICT",
  as: "space",
});

ProjectTaskModel.belongsTo(UserModel, {
...
export class ProjectTaskConversationModel extends WorkspaceAwareModel<ProjectTaskConversationModel> {
  declare createdAt: CreationOptional<Date>;

  declare projectTodoId: ForeignKey<ProjectTaskModel["id"]>;
  declare conversationId: ForeignKey<ConversationModel["id"]>;

  declare projectTodo: NonAttribute<ProjectTaskModel>;
  declare conversation: NonAttribute<ConversationModel>;
}

ProjectTaskConversationModel.init(
  {
    createdAt: {
      type: DataTypes.DATE,
      allowNull: false,
...
ProjectTaskConversationModel.belongsTo(ProjectTaskModel, {
  foreignKey: { name: "projectTodoId", allowNull: false },
  onDelete: "RESTRICT",
  as: "projectTodo",
});

ProjectTaskModel.hasMany(ProjectTaskConversationModel, {
  foreignKey: { name: "projectTodoId", allowNull: false },
  as: "conversations",
});

ProjectTaskConversationModel.belongsTo(ConversationModel, {
...
export class ProjectTaskSourceModel extends WorkspaceAwareModel<ProjectTaskSourceModel> {
  declare createdAt: CreationOptional<Date>;
...
ProjectTaskSourceModel.belongsTo(ProjectTaskModel, {
  foreignKey: { name: "projectTodoId", allowNull: false },
  onDelete: "RESTRICT",
  as: "projectTodo",
});

ProjectTaskModel.hasMany(ProjectTaskSourceModel, {
  foreignKey: { name: "projectTodoId", allowNull: false },
  as: "sources",
});
