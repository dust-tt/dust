...
export const issueClosedSchema: JSONSchema = {
  $schema: "http://json-schema.org/draft-07/schema",
  type: "object",
  title: "jira:issue_closed event",
  required: [
    "timestamp",
    "webhookEvent",
  ...
  properties: {
    ...
    issue: {
      type: "object",
      description: "The Jira issue that was closed",
      properties: {
        id: {
          type: "string",
...
export const issueClosedExample = {
  timestamp: 1736938800000,
  webhookEvent: "jira:issue_closed",
  ...
  issue: {
    ...
    key: "PROJ-1",
    fields: {
      statuscategorychangedate: "2025-01-15T12:00:00.000+0000",
      issuetype: {
      ...
      resolutiondate: "2025-01-15T12:00:00.000+0000",
      workratio: -1,
      ...
      lastViewed: "2025-01-15T12:00:00.000+0000",
      creator: {
        self: "https://example.atlassian.net/rest/api/2/user?accountId=000000%3A00000000-0000-0000-0000-000000000000",
        accountId: "000000:00000000-0000-0000-0000-000000000000",
        avatarUrls: {
