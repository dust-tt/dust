...
// Types for validation requirements
...
interface ValidationRequirementsContextType {
...
const ValidationRequirementsContext =
  createContext<ValidationRequirementsContextType | null>(null);

export function useValidationRequirementsContext() {
  const context = useContext(ValidationRequirementsContext);
  if (!context) {
    throw new Error(
      "useValidationRequirementsContext must be used within ValidationRequirementsProvider"
    );
  }
  return context;
}

interface ValidationRequirementsProviderProps {
  owner: LightWorkspaceType;
  conversation: ConversationWithoutContentType | null;
  children: ReactNode;
}

export function ValidationRequirementsProvider({
  owner,
  conversation,
  children,
}: ValidationRequirementsProviderProps) {
  ...
  return (
    <ValidationRequirementsContext.Provider
      value={{
        showValidationDialog,
