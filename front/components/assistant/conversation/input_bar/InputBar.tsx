            ...
            : classNames(
                ...
                isFloating &&
                  classNames(
                    ...
                    "md:has-[.tiptap:focus]:shadow-[0px_0px_0px_1px_rgba(0,0,0,0.07),0px_1px_1px_-0.5px_rgba(0,0,0,0.06),0px_3px_3px_-1.5px_rgba(0,0,0,0.05),0px_6px_6px_-3px_rgba(0,0,0,0.04)]",
                    "md:bg-[#fbfbfb]",
                    ...
                    "md:dark:has-[.tiptap:focus]:shadow-[inset_0px_1px_0px_0px_rgba(255,255,255,0.035),inset_0px_0px_0px_1px_rgba(255,255,255,0.055),0px_0px_0px_1px_rgba(0,0,0,0.14),0px_1px_1px_-0.5px_rgba(0,0,0,0.18),0px_3px_3px_-1.5px_rgba(0,0,0,0.18),0px_6px_6px_-3px_rgba(0,0,0,0.18)]"
                  )
              )
        )}
      >
        {!effectiveIsCompact && isFloating && (
          <div
            aria-hidden
            className="pointer-events-none absolute -inset-px hidden rounded-[inherit] [corner-shape:inherit] shadow-[inset_0px_-3px_29px_2px_rgba(0,0,0,0.01)] md:block dark:hidden"
          />
        )}
        <div
          className={classNames(
