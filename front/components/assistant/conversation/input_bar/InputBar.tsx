        ...
        >
          <div
            className={classNames(
              ...
              "dark:bg-muted-background-darkMode bg-muted-background",
              "border",
              "dark:border-border-dark-darkMode border-border-dark",
              "sm:border-border-dark/50 sm:focus-within:border-border-dark",
              "dark:focus-within:border-border-dark-darkMode sm:focus-within:border-border-dark",
              isFloating
                ? classNames(
                    "focus-within:ring-1 dark:focus-within:ring-1",
                    "dark:focus-within:ring-highlight/30-darkMode focus-within:ring-highlight/30",
                    "sm:focus-within:ring-2 dark:sm:focus-within:ring-2"
                  )
                : classNames(
                    "focus-within:border-highlight-300",
                    "dark:focus-within:border-highlight-300-darkMode"
                  ),
