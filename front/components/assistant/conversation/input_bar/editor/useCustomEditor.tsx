...
import type { RichMention } from "@app/lib/mentions";
...
/**
 * Extract text and mentions from editor JSON content.
 * This is a wrapper around the centralized extractFromEditorJSON utility.
 */
