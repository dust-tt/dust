...
export const AgentInputBar = ({ context }: AgentInputBarProps) => {
  ...
  if (
    ...
    return (
      <div className="relative z-20 mx-auto flex w-full flex-col pt-4 pb-6 md:max-w-[calc(var(--container-conversation)+2rem)] md:px-4">
        <PodJoinCTA
          owner={context.owner}
  ...
  if (context.projectId && context.isProjectArchived) {
    return (
      <div className="mx-auto flex w-full flex-col py-4 md:max-w-[calc(var(--container-conversation)+2rem)] md:px-4">
        <EmptyCTA
  ...
  return (
    <div
      className={classNames(
        ...
        // wrappers: constant md:px-4 so the composer shadow never clips,
        // max-w widened by the same 2rem to keep the wide-viewport width.
        "relative z-20 mx-auto flex w-full flex-col pt-4 pb-6 md:max-w-[calc(var(--container-conversation)+2rem)] md:px-4"
      )}
    >
