...
interface PublicCanvasHeaderProps {
  title: string;
}
...
// elements.
// TODO(CANVAS 2025-08-27): optimize the header for mobile views once we have buttons.
export function PublicCanvasHeader({ title }: PublicCanvasHeaderProps) {
  return (
