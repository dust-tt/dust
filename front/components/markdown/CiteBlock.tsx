        ...
        {refs.map((r, i) => {
          ...
          return (
            <div key={`${r.ref}-${i}`}>
              ...
              >
                <div className="group flex translate-y-1 flex-row items-center justify-center space-x-1 rounded-lg bg-muted-background p-1 text-xs font-medium text-muted-foreground dark:bg-muted-background-night dark:text-muted-foreground-night">
