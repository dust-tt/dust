...
export function getPageAndFooter(props: ExtendedPageContentProps): {
  ...
  // Count only NEW selections (not already-added skills)
  const newlySelectedSkillsCount =
    props.localSelectedSkills.length - props.initialSelectedSkills.length;
  const totalSelected = newlySelectedSkillsCount + selectedToolsInSheet.length;
