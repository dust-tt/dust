...
import { CheckV2, Icon, XCloseV2 } from "@dust-tt/sparkle";
...
const STATUS_CONFIG: Record<FeatureStatus, { bg: string; content: ReactNode }> =
  {
    yes: {
      bg: "bg-emerald-100",
      content: (
        <Icon visual={CheckV2} className="h-4 w-4 text-emerald-600" size="sm" />
      ),
    },
    no: {
      bg: "bg-red-100",
      content: <Icon visual={XCloseV2} className="h-4 w-4 text-red-500" />,
    },
    partial: {
      bg: "bg-amber-100",
