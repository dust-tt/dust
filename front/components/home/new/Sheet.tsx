...
>(({ side = "right", className = "", children, ...props }, ref) => (
  <SheetPortal>
    ...
    >
      {children}
      <SheetPrimitive.Close className="ring-offset-background focus:ring-ring data-[state=open]:bg-secondary absolute right-4 top-4 transform rounded-sm text-slate-400 opacity-70 transition-opacity transition-transform hover:rotate-90 hover:text-slate-100 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:pointer-events-none">
