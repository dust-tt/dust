...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "border-input flex h-10 w-full items-center justify-between rounded-md border px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1",
      "bg-background dark:bg-background-night",
      "ring-offset-background dark:ring-offset-background-night",
      "placeholder:text-muted-foreground dark:placeholder:text-muted-foreground-night",
      "focus:ring-ring dark:focus:ring-ring-night",
      className
    )}
    {...props}
  >
