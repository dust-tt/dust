  ...
  return (
    <section className="flex flex-col gap-3">
      ...
      {(currentInstructions?.length ?? 0) >
        ...
        <ContentMessage variant="warning" size="lg" title="This skill is noticeably large">
          Large skills use more of the context window each time they run.
          Consider keeping your guidelines concise.
        </ContentMessage>
      )}
