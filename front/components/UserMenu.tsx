...
export function UserMenu({ user, owner, subscription }: UserMenuProps) {
  ...
  return (
    <>
      ...
      />
      <DropdownMenu>
        <DropdownMenuTrigger className="hover:bg-sidebar-foreground data-[state=open]:bg-sidebar-foreground dark:hover:bg-sidebar-foreground-night dark:data-[state=open]:bg-sidebar-hover-night rounded-xl p-2 m-2">
