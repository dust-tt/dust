  ...
  const onDatasetDataModalSave = async () => {
    ...
    if (dataset) {
      const res = await fetch(
        `/api/w/${owner.sId}/vaults/${app.space.sId}/apps/${app.sId}/datasets/${block.config.dataset}`,
        {
          method: "POST",
          headers: {
            ...
            >
              {readOnly ? null : (
                <Button
                  ...
                  variant="outline"
                  onClick={() => {
                    window.location.href = `/w/${owner.sId}/vaults/${app.space.sId}/apps/${app.sId}/datasets/${block.config.dataset}`;
                  }}
