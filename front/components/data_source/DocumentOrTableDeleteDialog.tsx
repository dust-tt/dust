...
export const DocumentOrTableDeleteDialog = ({
  ...
  const handleDelete = async () => {
    try {
      setIsLoading(true);
      const endpoint = `/api/w/${owner.sId}/vaults/${dataSourceView.spaceId}/data_sources/${dataSourceView.dataSource.sId}/${itemType}s/${encodeURIComponent(contentNode.internalId)}`;
