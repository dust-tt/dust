...
export const sendAPIUserEmail = async ({ email }: { email: string }) => {
  const msg = {
    ...
    html: `<p>Hi!</p>
    <p>Between 2:54 UTC and X:XX UTC today, OpenAI encountered a major outage of their APIs. The incident is resolved now and all services on Dust are now operational.</p>
