...
const {
  ...
  DUST_REGION = "",
  DUST_MANAGED_AZURE_SPEECH_API_KEY = "",
  DUST_MANAGED_AZURE_SPEECH_REGION = "",
} = process.env;
...
export const dustManagedCredentials = (options?: {
  ...
  return {
    ...
    AZURE_SPEECH_API_KEY: DUST_MANAGED_AZURE_SPEECH_API_KEY,
    AZURE_SPEECH_REGION: DUST_MANAGED_AZURE_SPEECH_REGION,
  };
};
