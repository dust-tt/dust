...
> = {
  free: { bg: "bg-gray-100", iconColor: "text-gray-700", Icon: FreeSeatIcon },
  pro: { bg: "bg-blue-100", iconColor: "text-blue-500", Icon: ProSeatIcon },
  max: { bg: "bg-golden-100", iconColor: "text-golden-600", Icon: MaxSeatIcon },
};
