...
import { Pagination } from "@marketing/components/shared/Pagination";
import {
...
import type { CourseListingPageProps } from "@marketing/lib/contentful/types";
import {
  useAcademyBackfill,
  useAcademyBrowserId,
...
> = async (context) => {
  ...
  // Marketing does not resolve the academy user at SSR — client-side hooks
  // pick up authenticated progress via the cookie when calling the academy
  // endpoints (served by front today).
