...
import type {
  EbookFormData,
  EbookSubmitResponse,
} from "@marketing/lib/api/hubspot/ebookFormSchema";
import {
  EbookFormSchema,
  TrackingParamsSchema,
} from "@marketing/lib/api/hubspot/ebookFormSchema";
import { submitToHubSpotEbookForm } from "@marketing/lib/api/hubspot/hubspot";
import { extractDomain, hasValidMxRecords } from "@marketing/lib/utils/email";
import { isPersonalEmailDomain } from "@marketing/lib/utils/personal_email_domains";
