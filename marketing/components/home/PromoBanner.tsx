...
const CURRENT_PROMO: PromoConfig | null = {
  ...
  badge: "Online Event",
  title: "June Product Update - Pods",
  time: "June 24 · 5:30pm CEST / 8:30am PDT",
  linkLabel: "Register Now",
  // Banner auto-hides after this date (June 24th 7:00 PM Paris / CEST).
  expiresAt: new Date("2026-06-24T19:00:00+02:00"),
};
// =============================================================================
