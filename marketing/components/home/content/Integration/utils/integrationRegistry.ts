...
import { INTERNAL_MCP_SERVERS } from "@marketing/lib/actions/mcp_internal_actions/constants";
import { DEFAULT_REMOTE_MCP_SERVERS } from "@marketing/lib/actions/mcp_internal_actions/remote_servers";
import { CONNECTOR_CONFIGURATIONS } from "@marketing/lib/connector_providers";
import { CONNECTOR_UI_CONFIGURATIONS } from "@marketing/lib/connector_providers_ui";
...
export function buildIntegrationRegistry(): IntegrationBase[] {
  ...
  for (const remote of DEFAULT_REMOTE_MCP_SERVERS) {
    ...
    integrationMap.set(slug, {
      ...
      icon: remote.icon as InternalAllowedIconType,
