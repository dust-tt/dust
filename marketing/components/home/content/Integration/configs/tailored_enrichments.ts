// Tailored integration enrichments — one hand-reviewable block per listing.
// Each `chatStoryline` + `benefits` set is authored from the integration's REAL MCP tool
// names (every toolCalls/toolMatches entry is validated to exist on that integration).
// Merged over the base enrichments in `index.ts`; when a listing here defines `benefits`,
// the merge drops that listing's legacy `useCases` so the tailored BenefitsSection renders.

import type { IntegrationEnrichment } from "../types";

export const tailoredEnrichments: Record<
  string,
  Partial<IntegrationEnrichment>
> = {
  // [generic] Adomik — 4 real tools
  adomik: {
    chatStoryline: {
      userPrompt:
  ...
  // [generic] Amplitude — 24 real tools
  amplitude: {
    chatStoryline: {
      userPrompt:
  ...
  // [generic] Clari Copilot — 2 real tools
  clari_copilot: {
    chatStoryline: {
      userPrompt:
  ...
  // [generic] Contentsquare — 21 real tools
  contentsquare: {
    chatStoryline: {
      userPrompt:
  ...
  // [generic] NetSuite — 11 real tools
  netsuite: {
    chatStoryline: {
      userPrompt:
      ...
      responseSections: [
        {
          ...
          bullets: [
            { title: "Page", body: '"Acme Cloud Status" (acme.statuspage.io)' },
            {
              title: "Incident",
  ...
  // [generic] UKG Ready — 8 real tools
  ukg_ready: {
    chatStoryline: {
      userPrompt:
  ...
  // [legacy] Confluence — 6 real tools
  confluence: {
    chatStoryline: {
      userPrompt:
  ...
  // [legacy] Databricks — 1 real tools
  databricks: {
    chatStoryline: {
      userPrompt:
  ...
  // [legacy] Freshservice — 28 real tools
  freshservice: {
    chatStoryline: {
      userPrompt:
  ...
  // [legacy] Google Calendar — 8 real tools
  google_calendar: {
    chatStoryline: {
      userPrompt:
  ...
  // [legacy] Google Drive — 24 real tools
  google_drive: {
    chatStoryline: {
      userPrompt:
  ...
  // [legacy] Google Sheets — 13 real tools
  google_sheets: {
    chatStoryline: {
      userPrompt:
  ...
  // [legacy] Microsoft Excel — 6 real tools
  microsoft_excel: {
    chatStoryline: {
      userPrompt:
  ...
  // [legacy] Microsoft OneDrive — 8 real tools
  microsoft_drive: {
    chatStoryline: {
      userPrompt:
  ...
  // [legacy] Microsoft Teams — 9 real tools
  microsoft_teams: {
    chatStoryline: {
      userPrompt:
  ...
  // [legacy] Monday.com — 28 real tools
  monday: {
    chatStoryline: {
      userPrompt:
  ...
  // [legacy] Outlook Calendar — 9 real tools
  outlook_calendar: {
    chatStoryline: {
      userPrompt:
  ...
  // [legacy] Productboard — 9 real tools
  productboard: {
    chatStoryline: {
      userPrompt:
  ...
  // [legacy] Salesforce — 7 real tools
  salesforce: {
    chatStoryline: {
      userPrompt:
