 ...
 * Every library exposed to Frame source MUST be returned here. The validation package derives
 * its module names and declarations from this function's return type, including bound hooks.
 */
