...
describe("revision-aware file access", () => {
  it("returns file contents and their revision in a separate snapshot", async () => {
    ...
    const file = await api.readFile("./notes.json");
