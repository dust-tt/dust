  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        "action": {
          "500": {DEFAULT: colors.violet[500], "dark": colors.blue[500]},
          "400": {DEFAULT: colors.violet[400], "dark": colors.blue[600]},
          "200": {DEFAULT: colors.violet[200], "dark": colors.blue[800]},
          "300": {DEFAULT: colors.violet[300], "dark": colors.blue[700]},
          "100": {DEFAULT: colors.violet[100], "dark": colors.blue[900]},
          "600": {DEFAULT: colors.violet[600], "dark": colors.blue[400]},
          "700": {DEFAULT: colors.violet[700], "dark": colors.blue[300]},
          "800": {DEFAULT: colors.violet[800], "dark": colors.blue[200]},
          "900": {DEFAULT: colors.violet[900], "dark": colors.blue[100]},
          "950": {DEFAULT: colors.violet[950], "dark": colors.blue[50]},
          "50": {DEFAULT: colors.violet[50], "dark": colors.blue[950]},
        },
        "ok": {
