...
const SvgMicrosoftExcel = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      fill="#fff"
      d="m4.3 15 1.941-3.008L4.463 9h1.43l.971 1.913q.135.273.184.406h.013q.096-.218.201-.422L8.3 9h1.314L7.79 11.975 9.66 15H8.262l-1.12-2.1a2 2 0 0 1-.135-.28h-.016a1.3 1.3 0 0 1-.13.271L5.706 15z"
    />
  </svg>
);
