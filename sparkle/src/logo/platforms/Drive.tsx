...
const SvgDrive = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      fill="#00AC47"
      d="M12 8.581 8.535 2.316c-.34.21-.63.5-.832.869l-6.4 11.583c-.199.36-.303.768-.303 1.184h6.93z"
    />
    <path
      fill="#EA4335"
      d="M19.535 22.218c.34-.211.63-.5.832-.87l.403-.723 1.928-3.488c.201-.369.302-.777.302-1.185h-6.93l1.474 3.028z"
    />
    <path
      fill="#00832D"
    ...
    <path
      fill="#2684FC"
      d="M16.07 15.952H7.93l-3.465 6.266c.34.21.73.315 1.134.315h12.802a2.27 2.27 0 0 0 1.134-.316z"
    />
    <path
      fill="#FFBA00"
