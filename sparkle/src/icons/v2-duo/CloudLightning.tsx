...
const SvgCloudLightning = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g fill="currentColor" clipPath="url(#cloud-lightning_svg__a)">
      <path
        ...
        opacity={0.4}
      />
      <path d="M12.139 9.426a1.035 1.035 0 0 1 1.723 1.148l-2.927 4.39H15a1.035 1.035 0 0 1 .861 1.61l-4 6a1.035 1.035 0 0 1-1.722-1.148l2.927-4.39H9a1.035 1.035 0 0 1-.861-1.61z" />
    </g>
    <defs>
