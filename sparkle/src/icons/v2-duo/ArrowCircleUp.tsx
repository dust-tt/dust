...
const SvgArrowCircleUp = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g fill="currentColor" clipPath="url(#arrow-circle-up_svg__a)">
      <path
        ...
        opacity={0.4}
      />
      <path d="M10.965 16v-5.502L8.73 12.732a1.034 1.034 0 1 1-1.463-1.463l4-4 .079-.072a1.035 1.035 0 0 1 1.384.072l4 4a1.034 1.034 0 1 1-1.463 1.463l-2.233-2.234V16a1.035 1.035 0 0 1-2.07 0" />
    </g>
    <defs>
