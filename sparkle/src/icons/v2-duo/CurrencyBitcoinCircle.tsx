...
const SvgCurrencyBitcoinCircle = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g fill="currentColor" clipPath="url(#currency-bitcoin-circle_svg__a)">
      <path
