...
const SvgArrowCircleLeft = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g fill="currentColor" clipPath="url(#arrow-circle-left_svg__a)">
      <path
        ...
        opacity={0.4}
      />
      <path d="M11.269 7.268a1.034 1.034 0 1 1 1.462 1.463l-2.233 2.234H16a1.035 1.035 0 0 1 0 2.07h-5.502l2.233 2.233a1.034 1.034 0 1 1-1.463 1.463l-4-4a1.034 1.034 0 0 1 0-1.463z" />
    </g>
    <defs>
