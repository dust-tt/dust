...
const SvgAlertCircle = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g fill="currentColor" clipPath="url(#alert-circle_svg__a)">
      <path
        ...
        opacity={0.4}
      />
      <path d="M12.01 14.965a1.035 1.035 0 0 1 0 2.07H12a1.035 1.035 0 0 1 0-2.07zM10.965 12V8a1.035 1.035 0 0 1 2.07 0v4a1.035 1.035 0 0 1-2.07 0" />
    </g>
    <defs>
