...
const SvgCurrencyDollarCircle = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g fill="currentColor" clipPath="url(#currency-dollar-circle_svg__a)">
      <path
        ...
        opacity={0.4}
      />
      <path d="M14.465 9.333c0-.717-.581-1.298-1.298-1.298H11a1.465 1.465 0 1 0 0 2.93h2a3.535 3.535 0 0 1 .035 7.07v.465a1.035 1.035 0 0 1-2.07 0v-.465h-.132a3.37 3.37 0 0 1-3.368-3.368 1.035 1.035 0 0 1 2.07 0c0 .717.581 1.298 1.298 1.298H13a1.465 1.465 0 1 0 0-2.93h-2a3.535 3.535 0 0 1-.035-7.07V5.5a1.035 1.035 0 0 1 2.07 0v.465h.132a3.37 3.37 0 0 1 3.368 3.368 1.035 1.035 0 0 1-2.07 0" />
    </g>
    <defs>
