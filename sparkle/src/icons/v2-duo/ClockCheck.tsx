...
const SvgClockCheck = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g fill="currentColor" clipPath="url(#clock-check_svg__a)">
      <path
        d="M20.269 15.769a1.034 1.034 0 1 1 1.463 1.462l-4.5 4.5a1.034 1.034 0 0 1-1.463 0l-2-2a1.034 1.034 0 1 1 1.463-1.463l1.268 1.269z"
        opacity={0.4}
      />
