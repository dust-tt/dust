...
const SvgAlarmClockCheck = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      fill="currentColor"
      d="M18.965 13a6.965 6.965 0 1 0-13.93 0 6.965 6.965 0 0 0 13.93 0m-4.196-2.731a1.034 1.034 0 1 1 1.462 1.462l-4.5 4.5a1.034 1.034 0 0 1-1.462 0l-2-2A1.034 1.034 0 1 1 9.73 12.77L11 14.037zM21.035 13a9.035 9.035 0 1 1-18.07 0 9.035 9.035 0 0 1 18.07 0"
    />
  </svg>
);
