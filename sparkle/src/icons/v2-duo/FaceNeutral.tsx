...
const SvgFaceNeutral = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g fill="currentColor" clipPath="url(#face-neutral_svg__a)">
      <path
        ...
        opacity={0.4}
      />
      <path d="M16 13.965a1.035 1.035 0 0 1 0 2.07H8a1.035 1.035 0 0 1 0-2.07zM9.157 7.473a1.536 1.536 0 1 1-1.684 1.684L7.465 9l.008-.157A1.536 1.536 0 0 1 9 7.465zm6 0A1.536 1.536 0 1 1 15 7.465z" />
    </g>
    <defs>
