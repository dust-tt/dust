...
const SvgCurrencyEuroCircle = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g fill="currentColor" clipPath="url(#currency-euro-circle_svg__a)">
      <path
        ...
        opacity={0.4}
      />
      <path d="M5.965 12q.002-.235.02-.466A1.035 1.035 0 0 1 6 9.464h.523a6.035 6.035 0 0 1 9.5-1.962 1.036 1.036 0 0 1-1.38 1.542A3.95 3.95 0 0 0 12 8.035a3.96 3.96 0 0 0-3.049 1.43H11a1.035 1.035 0 0 1 0 2.07H8.063a4 4 0 0 0 0 .93H11a1.035 1.035 0 0 1 0 2.07H8.951A3.96 3.96 0 0 0 12 15.965c1.016 0 1.941-.38 2.644-1.009a1.035 1.035 0 1 1 1.38 1.542 6.035 6.035 0 0 1-9.5-1.963H6a1.035 1.035 0 0 1-.015-2.07 6 6 0 0 1-.02-.465" />
    </g>
    <defs>
