...
const SvgPauseCircle = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g fill="currentColor" clipPath="url(#pause-circle_svg__a)">
      <path
        ...
        opacity={0.4}
      />
      <path d="M8.465 15V9a1.035 1.035 0 0 1 2.07 0v6a1.035 1.035 0 0 1-2.07 0m5 0V9a1.035 1.035 0 0 1 2.07 0v6a1.035 1.035 0 0 1-2.07 0" />
    </g>
    <defs>
