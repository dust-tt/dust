  ...
  render: () => {
    ...
    const handleNext = () => {
      if (currentPageId === "welcome") {
        setCurrentPageId("features");
      } else if (currentPageId === "features") {
        setCurrentPageId("finish");
      }
    };

    const handlePrevious = () => {
      if (currentPageId === "finish") {
        setCurrentPageId("features");
      } else if (currentPageId === "features") {
    ...
    const isFirstPage = currentPageId === "welcome";
    const isLastPage = currentPageId === "finish";

    const onboardingPages: MultiPageDialogPage[] = [
      {
        id: "welcome",
        ...
        content: (
          <div className="s-space-y-4">
            <div>
              ...
              <p className="s-text-sm s-text-muted-foreground">
                This dialog demonstrates the hideCloseButton prop. Notice that
                there's no close button (X) in the top-right corner of the
                header.
              </p>
            </div>
            <div className="s-rounded-md s-border s-bg-blue-50 s-p-4">
              ...
              <ul className="s-space-y-1 s-text-sm s-text-blue-700">
                <li>• No close button in header</li>
                <li>• Users must use Cancel or Complete buttons</li>
                <li>• Perfect for onboarding flows</li>
                <li>• Prevents accidental dismissal</li>
              </ul>
            </div>
            <div className="s-space-y-3">
              <div>
                <label className="s-text-sm s-font-medium">Your Name</label>
                <input
                  type="text"
                  className="s-mt-1 s-w-full s-rounded-md s-border s-px-3 s-py-2"
                  placeholder="Enter your name"
              ...
              <div>
                <label className="s-text-sm s-font-medium">Company</label>
                <input
                  type="text"
                  className="s-mt-1 s-w-full s-rounded-md s-border s-px-3 s-py-2"
        ...
        content: (
          <div className="s-space-y-4">
            <div>
              ...
              <p className="s-text-sm s-text-muted-foreground">
                Explore the key features that make our platform special.
              </p>
            </div>
            <div className="s-space-y-3">
              {[
                ...
                <div
                  key={index}
                  className="s-flex s-items-start s-gap-3 s-rounded-md s-border s-p-3"
                >
                  <span className="s-text-xl">{feature.icon}</span>
                  <div>
                    <h4 className="s-text-sm s-font-medium">{feature.title}</h4>
                    <p className="s-text-xs s-text-muted-foreground">
                      {feature.description}
                    </p>
                  </div>
        ...
        content: (
          <div className="s-space-y-4">
            <div>
              ...
              <p className="s-text-sm s-text-muted-foreground">
                You've completed the onboarding process. You're now ready to
                start using our platform.
              </p>
            </div>
            <div className="s-rounded-md s-border s-bg-green-50 s-p-4">
              <h4 className="s-mb-2 s-text-sm s-font-semibold s-text-green-900">
                What's Next?
              </h4>
              <ul className="s-space-y-1 s-text-sm s-text-green-700">
            ...
            <div className="s-rounded-md s-border s-bg-blue-50 s-p-3">
              <p className="s-text-xs s-text-blue-700">
                💡 Tip: This dialog uses hideCloseButton=true to prevent users
                from accidentally closing the onboarding flow. Users must
                explicitly choose to complete or cancel the process.
              </p>
            </div>
          </div>
        ),
    ...
    return (
      <MultiPageDialog open={isOpen} onOpenChange={setIsOpen}>
        <MultiPageDialogTrigger asChild>
          <Button label="Start Onboarding (No Close Button)" />
        </MultiPageDialogTrigger>
        <MultiPageDialogContent
