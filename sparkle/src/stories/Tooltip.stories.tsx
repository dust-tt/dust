...
export const TooltipExample = () => (
  <Tooltip
    trigger={<div className="s:text-foreground">Hover</div>}
...
export const TooltipWithShortcut = () => (
  <Tooltip
    trigger={<div className="s:text-foreground">Hover for shortcut</div>}
...
export const TooltipWithKeyboardShortcutComponent = () => (
  <TooltipProvider>
    <TooltipRoot>
      <TooltipTrigger>
        <div className="s:text-foreground">Hover for inline shortcut</div>
      </TooltipTrigger>
      <TooltipContent>
