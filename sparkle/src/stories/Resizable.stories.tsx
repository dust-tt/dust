...
export function ResizableDemo() {
  return (
    <ResizablePanelGroup
      ...
      className="s:max-w-md s:rounded-lg s:border s:bg-white s:md:min-w-[450px]"
    >
...
export function ResizableHeaderDemo() {
  return (
    <ResizablePanelGroup
      direction="vertical"
      className="s:min-h-[200px] s:max-w-md s:rounded-lg s:border s:bg-white s:md:min-w-[450px]"
    >
      <ResizablePanel defaultSize={25}>
        <div className="s:flex s:h-full s:items-center s:justify-center s:p-6">
