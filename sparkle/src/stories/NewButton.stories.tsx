...
export const ButtonExamples = () => (
  <div className="s-flex s-flex-col s-gap-4">
    ...
    <div className="s-flex s-items-center s-gap-4">
      ...
      <NewButton size="xs" variant="secondary" label="Button" />
    ...
    <div className="s-flex s-items-center s-gap-4">
      ...
      <NewButton size="xs" variant="secondary" label="Button" isLoading />
    ...
    <div className="s-flex s-items-center s-gap-4">
      ...
      <NewButton size="xs" variant="secondary" icon={PlusIcon} label="Button" />
    ...
    <div className="s-flex s-items-center s-gap-4">
      ...
      <NewButton size="sm" variant="secondary" label="Button" isLoading />
    ...
    <div className="s-flex s-items-center s-gap-4">
      ...
      <NewButton size="sm" variant="secondary" icon={PlusIcon} label="Button" />
    ...
    <div className="s-flex s-items-center s-gap-4">
      ...
      <NewButton size="md" variant="secondary" label="Button" isLoading />
    ...
    <div className="s-flex s-items-center s-gap-4">
      ...
      <NewButton size="md" variant="secondary" icon={PlusIcon} label="Button" />
