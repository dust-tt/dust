...
// Icons actively imported in the Dust product (codebase names with V2 suffix).
// The v2-stroke index exports without the V2 suffix, so we strip it to look up
// the component and keep the codebase name as the display label.
...
const icons = V2StrokeIcons as Record<
  string,
