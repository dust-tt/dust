...
export const NewCitationsExample = () => (
  <div className="s-flex s-flex-col s-gap-8">
    ...
    <NewCitationGrid>
      ...
      />
      <NewCitation
        visual={<FaviconIcon websiteUrl="https://www.linkedin.com" size="md" />}
        label="Linkedin, Edouard Wautier"
        tooltip="linkedin.com — Edouard Wautier, Designer at Dust"
        onClick={() => alert("Card clicked")}
      />
      <NewCitation
        visual={<FaviconIcon websiteUrl="https://github.com" size="md" />}
    ...
    <NewCitationGrid>
      <NewCitation
        visual={
          <>
            <Icon visual={DriveLogo} size="sm" />
            <Icon visual={FolderIcon} size="sm" />
          </>
        }
        label="Q4 Reports"
    ...
    <NewCitationGrid>
      ...
      />
      <NewCitation
        visual={<Icon visual={GlobeAltIcon} size="sm" />}
        label="Linkedin, Edouard Wautier"
    ...
    <NewCitationGrid>
      <NewCitation
        size="lg"
        visual={<Icon visual={ImageIcon} size="sm" />}
    ...
    <NewCitationGrid>
      ...
      <NewCitation
        visual={
          <FaviconIcon websiteUrl="https://stackoverflow.com" size="md" />
        }
      ...
      <NewCitation
        visual={
          <FaviconIcon websiteUrl="https://www.wikipedia.org" size="md" />
        }
