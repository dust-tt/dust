...
export const ConversationExample = () => {
  return (
    <div className="s-flex s-w-full s-justify-center">
      <Conversation>
        <Conversation.Message
          type="user"
          header={
            <Conversation.MessageHeader
              name="Edouard"
            ...
            <Conversation.MessageContent
              ...
              message={
                <>
                  ...
                  check around the block that renders the citations. This can be
                  done using a logical && operator, which will only render the
                  content on its right side if the condition on its left side is
                  true. In this case, the condition is the presence of
                  citations.
                </>
              }
            />
            ...
            <Conversation.MessageContent
              message={
                <>
                  ...
                  that: Dust is the place where they can use AI for productivity
                  Dust is where they can find answers on the knwledge of the
                  company Make 10 proposals of short text
                </>
              }
            />
          }
