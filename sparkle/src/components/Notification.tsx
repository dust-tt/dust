  ...
  return (
    <div
      className={cn(
        ...
        "s-bg-background/80 dark:s-bg-background-night/80 s-shadow-md s-backdrop-blur-sm",
        "s-cursor-pointer s-p-2 s-pb-3 s-transition-colors hover:s-bg-muted/50 dark:hover:s-bg-muted-night/50"
      )}
      onClick={onDismiss}
    >
