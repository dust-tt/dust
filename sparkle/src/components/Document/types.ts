...
import type { DocumentVisualReference } from "./DocumentVisual";
...
export interface DocumentProps {
  ...
  className?: string;
  readOnly?: boolean;
  /** Presentation tokens for content. Editing controls retain Sparkle styling. */
  theme?: DocumentTheme;
  /** Host renderer for named visual blocks. JSON stores only the visual name. */
  renderVisual?: (reference: DocumentVisualReference) => ReactNode;
