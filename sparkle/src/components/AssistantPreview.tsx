...
const titleClassNames = {
  ...
  minimalGallery: `s-overflow-hidden s-whitespace-nowrap ${
    getWindowWidth() <= breakpoints.sm ? "s-text-sm" : getWindowWidth() <= breakpoints.md ? "s-text-base" : ""
  }`,
};
...
const subtitleClassNames = {
  ...
  gallery: "s-text-sm",
  minimalGallery: `s-overflow-hidden s-whitespace-nowrap ${
    getWindowWidth() <= breakpoints.sm ? "s-text-xs" : getWindowWidth() <= breakpoints.md ? "s-text-sm" : ""
  }`,
};
  ...
  return (
    <>
      ...
      >
        ...
        <div
          id="actions-column"
          className="s-flex s-shrink-0 s-w-fit"
        >
