...
>(
  (
    ...
    const triggerClassName = cn(
      ...
      "s-font-medium",
      "s-bg-transparent",
      "data-[state=active]:s-bg-stone-100 data-[state=active]:s-text-foreground",
      "dark:data-[state=active]:s-bg-primary-200-night dark:data-[state=active]:s-text-foreground-night",
