...
interface NewConversationMessageAvatarProps
  extends React.HTMLAttributes<HTMLDivElement> {
...
export const NewConversationMessageAvatar = React.forwardRef<
  HTMLDivElement,
  NewConversationMessageAvatarProps
>(
  (
...
NewConversationMessageAvatar.displayName = "NewConversationMessageAvatar";

interface NewConversationMessageTitleProps
  extends React.HTMLAttributes<HTMLDivElement> {
  name?: string;
  timestamp?: string;
  infoChip?: React.ReactNode;
...
export const NewConversationMessageTitle = React.forwardRef<
  HTMLDivElement,
  NewConversationMessageTitleProps
>(
  (
    {
      name = "",
...
NewConversationMessageTitle.displayName = "NewConversationMessageTitle";
