...
module.exports = {
  theme: {
    ...
    extend: {
      ...
      dropShadow: {
        DEFAULT: "0 2px 4px oklch(18.98% 0.0094 255.63 / 0.0627)",
        sm: "0 1px 2px oklch(18.98% 0.0094 255.63 / 0.051)",
        md: "0 4px 6px oklch(18.98% 0.0094 255.63 / 0.1216)",
        lg: "0 10px 15px oklch(18.98% 0.0094 255.63 / 0.1216)",
        xl: "0 20px 20px oklch(18.98% 0.0094 255.63 / 0.1216)",
        "2xl": "0 25px 35px oklch(18.98% 0.0094 255.63 / 0.1216)",
      },
      boxShadow: {
        DEFAULT: "0 2px 6px 0 oklch(18.98% 0.0094 255.63 / 0.102)",
        md: "0 4px 12px oklch(18.98% 0.0094 255.63 / 0.1216)",
        lg: "0 10px 20px oklch(18.98% 0.0094 255.63 / 0.1216)",
        xl: "0 20px 25px oklch(18.98% 0.0094 255.63 / 0.1216)",
        "2xl": "0 25px 50px oklch(18.98% 0.0094 255.63 / 0.1216)",
      },
      zIndex: {
        60: "60",
      },
