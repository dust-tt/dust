...
# The Hono esbuild bundle leaves NEXT_PUBLIC_* references as runtime
# process.env lookups. Declaring regional runtime configuration in this stage
# would make otherwise identical regional builds use different cache keys.
