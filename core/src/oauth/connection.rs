use crate::oauth::{
    ...
    providers::{
        ...
        snowflake::SnowflakeConnectionProvider,
        snowflake_keypair::SnowflakeKeyPairConnectionProvider,
...
pub fn provider(t: ConnectionProvider) -> Box<dyn Provider + Sync + Send> {
    match t {
        ...
        ConnectionProvider::SnowflakeKeyPair => Box::new(SnowflakeKeyPairConnectionProvider::new()),
