...
use crate::providers::openai::{
    chat_completion, streamed_chat_completion, to_openai_messages, OpenAITool, OpenAIToolChoice,
};
...
#[derive(Serialize, Deserialize, Debug, Clone)]
pub struct TogetherAIError {
    pub error: InnerError,
}

impl TogetherAIError {
    pub fn message(&self) -> String {
        match self.error.internal_message {
            Some(ref msg) => format!(
                "TogetherAIError: [{}] {} internal_message={}",
