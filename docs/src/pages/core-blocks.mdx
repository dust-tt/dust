...
OpenAI's `gpt-4o` ([Chat API](https://platform.openai.com/docs/guides/chat)) or Anthropic's `claude-3-opus`. It has templated instructions
...
[Tera](https://keats.github.io/tera/docs/#templates) language. This is particularly useful to construct few-shot
...
app relying on this prompt can be found [here](https://dust.tt/w/0ec9852c2f/a/7d2750b6cc).
...
<Properties>
  <Property name="provider_id" type="string">
    The model provider to use. One of _openai_, _anthropic_, _mistral_ or _google_ai_studio_.
  </Property>
...
The `data_source` block provides an interface to query a [Data Source](/data-sources) and
...
their retrieved chunks score. Please refer to the [Data Sources overview](/data-sources)
