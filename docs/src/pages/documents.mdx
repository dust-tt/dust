...
source](/data-sources). {{ className: 'lead' }}
...
overview](/data-sources) to better understand how documents are chunked as part of a data
...
The Document model represents a [Data Source](/data-sources) document.
...
<Row>
  <Col>
    ...
    <Properties>
      ...
      <Property name="light_document_output" type="boolean">
        If true, a lightweight version of the document will be returned in the response (excluding the text, chunks and vectors).
        Defaults to `false`.
      </Property>
    </Properties>
