...
In this guide we will use a [Data Source](/data-sources) to store and index a set of
...
You can create your first Data Source from your Dust home page by selecting the **Folders** tab
and clicking on the **Add a new Folder** button. You'll simply need to provide a name and description.

<Image
  src="/guide_document_qa_newdatasource.png"
  alt="Dust Data Source creation panel"
>
  _The Dust Folder creation panel. The `name` should be short and memorable,
