...
You can now create a new app by clicking on **New App** from your main dashboard. You'll
...
Click on **Create Dataset** inside the `input` block to create a new dataset. You are now
redirected to the **Datasets** panel. And a new draft dataset with basic arithmetic questions has
...
<Note>
  ...
  your `data` block). You can change the name of your blocks by
