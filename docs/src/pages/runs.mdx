...
<Properties>
  ...
  >
    ...
    block name. The second element is an array of array of block executions. The
...
<Row>
  <Col>
    ...
    prefilled and ready to use curl command, click on the **Deploy** button from your app
